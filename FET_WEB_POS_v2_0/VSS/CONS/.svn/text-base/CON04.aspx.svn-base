<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="CON04.aspx.cs" Inherits="VSS_CON04_CON04" %>
    ...
    <div>
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="titlef">
            <tr>
                <td align="left">
                    <!--寄銷商品維護作業(總部)-->
                    <asp:Literal ID="Literal110" runat="server" Text="寄銷商品維護作業(總部)"></asp:Literal>
                </td>
                <td align="right">
        ...
        <div class="criteria">
            <table>                
                <tr>
                    <td align="right">
                        <!--廠商編號-->
                        <dx:ASPxLabel ID="Literal14" runat="server" Text="<%$ Resources:WebResources, SupplierNo %>"></dx:ASPxLabel>：
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <dx:ASPxTextBox ID="txtProductCode" runat="server"></dx:ASPxTextBox>
                    </td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td align="right">
                ...
                <tr>
                    <td align="right">
                        <!--商品名稱-->
                        <dx:ASPxLabel ID="Literal4" runat="server" Text="<%$ Resources:WebResources, ProductName %>"></dx:ASPxLabel>：
                    </td>
                    <td>
                    ...
                    <td colspan="3">
                        <table>
                            <tr>
                                ...
                                <td><dx:ASPxDateEdit ID="SupportDateRangeFrom" runat="server"></dx:ASPxDateEdit></td>
        ...
        <dx:ASPxPageControl ID="ASPxPageControl1" runat="server" Width="100%">
            <TabPages>
                <dx:TabPage Text="<%$ Resources:WebResources, CommissionRate %>">
                    <ContentCollection>
                        <dx:ContentControl>
        ...
        <div class="btnPosition">
            <table cellpadding="0" cellspacing="0" border="0" align="center">
                <tr>
                    ...
                    <td>&nbsp;</td>
                    <td><dx:ASPxButton ID="Button4" runat="server" Text="<%$ Resources:WebResources, Import %>" ClientSideEvents-Click="function(){openwindow('con04_1.aspx');return false;}" /></td>
                    <td>&nbsp;</td>
