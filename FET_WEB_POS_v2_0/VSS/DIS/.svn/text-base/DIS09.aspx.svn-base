<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DIS09.aspx.cs" Inherits="VSS_DIS09_DIS09" %>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td class="tdval" colspan="3">
                        ...
                        &nbsp;<asp:Literal ID="Literal6" runat="server" Text="<%$ Resources:WebResources, End %>"></asp:Literal><cc1:postbackDate_TextBox ID="postbackDate_TextBox2" runat="server" 
                            ImageUrl="~/Icon/calendar.jpg" />
                    </td>
                    <td class="tdtxt">
                        <!--更新日期-->
