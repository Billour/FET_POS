<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CHK02.aspx.cs" Inherits="VSS_CHK02_CHK02" MasterPageFile="~/MasterPage.master" %>
        ...
        <div class="criteria">
            <table>
                ...
                <tr>
                    ...
                    <td class="tdtxt">
                        <!--信用卡額-->
                        <asp:Literal ID="Literal22" runat="server" Text="<%$ Resources:WebResources, CreditCardAmount %>"></asp:Literal>：
                    </td>
                    <td class="tdval">
            ...
            <div class="btnPosition">
                <!--讀帳確認-->
                <dx:ASPxButton ID="Button2" runat="server" Text="<%$ Resources:WebResources, ConfirmingReadingCheck %>" Width="80" HorizontalAlign="Center" />
            </div>
        </div>
</asp:Content>
