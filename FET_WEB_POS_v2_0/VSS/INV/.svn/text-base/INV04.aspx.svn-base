<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="INV04.aspx.cs" Inherits="VSS_INV04_INV04" %>
        ...
        <div>
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="titlef">
                <tr>
                    ...
                    <td align="right">
                        <dx:ASPxButton ID="ASPxButton1" runat="server" Text="<%$ Resources:WebResources, ReturnWarehousingSettings %>"
                            AutoPostBack="false">
                            <ClientSideEvents Click="function(s, e){ document.location='INV05.aspx'; }" />
                        </dx:ASPxButton>
                    </td>
                </tr>
            </table>
