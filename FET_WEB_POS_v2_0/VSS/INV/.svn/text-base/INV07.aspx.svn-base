<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="INV07.aspx.cs" Inherits="VSS_INV07_INV07" %>
    ...
    <div>
        ...
        <cc:ASPxGridView ID="gvMaster" ClientInstanceName="gvMaster" runat="server" KeyFieldName="項次"
            ...
            <Columns>
                ...
                <dx:GridViewDataTextColumn FieldName="帳上庫存量" runat="server" ReadOnly="True" Caption="帳上庫存量"
                    VisibleIndex="4">
                    <PropertiesTextEdit>
                        <ReadOnlyStyle>
                            <Border BorderStyle="None" />
                ...
                <dx:GridViewDataTextColumn FieldName="未拆封數量" runat="server" ReadOnly="false" Caption="未拆封數量"
                    VisibleIndex="5">
                    <PropertiesTextEdit>
                        <ReadOnlyStyle>
                            <Border BorderStyle="None" />
                ...
                <dx:GridViewDataTextColumn FieldName="已拆封數量" runat="server" ReadOnly="false" Caption="已拆封數量"
                    VisibleIndex="6">
                    <PropertiesTextEdit>
                        <ReadOnlyStyle>
                            <Border BorderStyle="None" />
                ...
                <dx:GridViewDataTextColumn FieldName="退倉數量" runat="server" ReadOnly="True" Caption="退倉數量"
                    VisibleIndex="7">
                    <PropertiesTextEdit>
                        <ReadOnlyStyle>
                            <Border BorderStyle="None" />
                ...
                <dx:GridViewDataTextColumn FieldName="IMEI" runat="server" ReadOnly="True" Caption="IMEI"
                    VisibleIndex="8">
                    <PropertiesTextEdit>
                        <ReadOnlyStyle>
                            <Border BorderStyle="None" />
                    ...
                    <DataItemTemplate>
                        <table>
                            <tr>
                                ...
                                <td>
                                    <dx:ASPxButton ID="Button2" runat="server" Text="選" Visible="true" ClientSideEvents-Click="function(s,e){openwindow('../SAL/SAL01_inputIMEIData.aspx',500,400);return false;}" AutoPostBack="false">
                                    </dx:ASPxButton>
                                </td>
                            </tr>
                        </table>
                ...
                <dx:GridViewDataTextColumn FieldName="差異量" runat="server" ReadOnly="True" Caption="差異量"
                    VisibleIndex="9">
                    <PropertiesTextEdit>
                        <ReadOnlyStyle>
                            <Border BorderStyle="None" />
                ...
                <dx:GridViewDataTextColumn FieldName="ERP驗退日期" runat="server" ReadOnly="True" Caption="ERP驗退日期"
                    VisibleIndex="10">
                    <PropertiesTextEdit>
                        <ReadOnlyStyle>
                            <Border BorderStyle="None" />
                ...
                <dx:GridViewDataTextColumn FieldName="ERP驗退單號" runat="server" ReadOnly="True" Caption="ERP驗退單號"
                    VisibleIndex="11">
                    <PropertiesTextEdit>
                        <ReadOnlyStyle>
                            <Border BorderStyle="None" />
                ...
                <dx:GridViewDataTextColumn FieldName="驗退數量" runat="server" ReadOnly="True" Caption="驗退數量"
                    VisibleIndex="12">
                    <PropertiesTextEdit>
                        <ReadOnlyStyle>
                            <Border BorderStyle="None" />
    ...
    <div class="btnPosition">
        <table align="center" cellpadding="0" cellspacing="0" border="0">
            <tr>
                ...
                <td>
                    <dx:ASPxButton ID="btnClear" runat="server" Text="清空" />
                </td>
                <td>
                    &nbsp;
                </td>
                <td>
                    <dx:ASPxButton ID="ASPxButton2" runat="server" Text="列印" />
                </td>
            </tr>
        </table>
    </div>
