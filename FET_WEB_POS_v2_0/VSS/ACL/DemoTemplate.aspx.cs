...
public partial class VSS_ACL_DemoTemplate : System.Web.UI.Page
{
    ...
    private void bindDemo1(out string Message)
    {
        Message = string.Empty;
        DataTable dtRoleData = new DataTable();
        //取得資料
        dtRoleData = genRoleDataTemp();
        //存入ViewState
        ViewState["grdDemo1"] = dtRoleData;
        grdDemo1.DataSource = dtRoleData;
        grdDemo1.DataBind();
    }
    ...
    protected void grdDemo_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            e.Row.Attributes["onclick"] = string .Format("javascript:alert('{0}')",lbl .Text .Trim ());
        }
    }
}
