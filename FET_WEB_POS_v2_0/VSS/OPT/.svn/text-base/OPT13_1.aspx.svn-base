<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OPT13_1.aspx.cs" Inherits="VSS_OPT_OPT13_1" MasterPageFile="~/MasterPage.master" %>
            ...
            <div id="Div1" class="SubEditBlock">
                ...
                AutoGenerateColumns="False" OnRowInserting="gvMaster_RowInserting" onrowupdating="gvMaster_RowUpdating">
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn FieldName="促銷代號" Caption="<%$ Resources:WebResources, PromotionCode %>" HeaderStyle-HorizontalAlign="Center" >
                            <EditItemTemplate>
                                <table><tr>
                                    <td><dx:ASPxTextBox ID="txtPromotionCode" runat="server" Width="68px" Text='<%#Eval("[促銷代號]") %>'>
                                    </dx:ASPxTextBox></td>
                                    <td><dx:ASPxButton ID="ChoosePromotionCodeButton" runat="server" Text="<%$ Resources:WebResources, Choose %>" ClientSideEvents-Click="function(s,e){openwindow('../SAL/SAL01_choosePromotions.aspx',500,400);return false;}">
                                    </dx:ASPxButton></td>
                                </tr></table>
                            </EditItemTemplate>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="促銷名稱" Caption="<%$ Resources:WebResources, PromotionName %>" HeaderStyle-HorizontalAlign="Center" ReadOnly="true" >
                            <PropertiesTextEdit ReadOnlyStyle-Border-BorderStyle="None" />
                        </dx:GridViewDataTextColumn>
