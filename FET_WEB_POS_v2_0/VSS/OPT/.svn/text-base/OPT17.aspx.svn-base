<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master"
    CodeFile="OPT17.aspx.cs" Inherits="VSS_OPT17_OPT17" %>
                ...
                <div id="Div1" runat="server">
                    ...
                    <cc:ASPxGridView ID="gvMaster" runat="server" ClientInstanceName="gvMaster" KeyFieldName="項次"
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataComboBoxColumn FieldName="發票格式" Caption="發票格式" VisibleIndex="5">
                                <PropertiesComboBox>
                                    <Items>
                            ...
                            <dx:GridViewDataDateColumn FieldName="所屬年月起" Caption="所屬年月(起)" VisibleIndex="6">
                                <EditFormCaptionStyle Wrap="False">
                                </EditFormCaptionStyle>
                            </dx:GridViewDataDateColumn>
                            <dx:GridViewDataDateColumn FieldName="所屬年月訖" Caption="所屬年月(訖)" VisibleIndex="7">
                                <EditFormCaptionStyle Wrap="False">
                                </EditFormCaptionStyle>
                            </dx:GridViewDataDateColumn>
                            <dx:GridViewDataColumn FieldName="字軌" Caption="字軌" VisibleIndex="8">
                                <EditFormCaptionStyle Wrap="False">
                                </EditFormCaptionStyle>
                            </dx:GridViewDataColumn>
                            <dx:GridViewDataColumn FieldName="起始編號" Caption="起始編號" VisibleIndex="9">
                                <EditFormCaptionStyle Wrap="False">
                                </EditFormCaptionStyle>
                            </dx:GridViewDataColumn>
                            <dx:GridViewDataColumn FieldName="終止編號" Caption="終止編號" VisibleIndex="10">
                                <EditFormCaptionStyle Wrap="False">
                                </EditFormCaptionStyle>
                            </dx:GridViewDataColumn>
                            <dx:GridViewDataColumn FieldName="發票張數" Caption="發票張數" VisibleIndex="11" ReadOnly="true">
                                <EditFormSettings Visible="False" />
                            </dx:GridViewDataColumn>
