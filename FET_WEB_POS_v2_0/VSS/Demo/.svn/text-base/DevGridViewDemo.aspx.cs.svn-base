...
public partial class VSS_DevGridViewDemo : System.Web.UI.Page
{
    ...
    private DataTable getMasterData()
    {
        ...
        for (int i = 0; i < 13; i++)
        {
            ...
            NewRow["賠償項目"] = "電池" + i.ToString();
            NewRow["金額"] = "1200";

            NewRow["UnitPrice"] = Convert.ToString(10);
            NewRow["Quantity"] = Convert.ToString(10);
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        //Label2.Text = a.ToString();  ///this.aspxgridview1.getrowvalues
        int b = 0;
