<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="LEA01.aspx.cs" Inherits="VSS_LEA01_LEA01" %>
    ...
    <div class="btnPosition">
        <table cellpadding="0" cellspacing="0" border="0" align="center">
            <tr>
                ...
                <td align="left">
                    <dx:ASPxButton ID="btnCancel" runat="server" Text="取消" />
                </td>
                <td>
                    &nbsp;
                </td>
                <td align="left">
                    <dx:ASPxButton ID="btnDelete" runat="server" Text="刪除" />
                </td>
                <td>
                    &nbsp;
                </td>
                <td align="left">
                    <dx:ASPxButton ID="btnImport" runat="server" Text="匯入" />
                </td>
            </tr>
        </table>
    </div>
