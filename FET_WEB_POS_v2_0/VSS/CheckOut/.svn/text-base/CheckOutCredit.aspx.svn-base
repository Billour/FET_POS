    ...
    <div>
                ...
                <tr>
                    <td colspan="2" align="center">
                        <table border="0" cellpadding="0" cellspacing="0" align="center">
                            <tr>
                                <td>
                                    <dx:ASPxButton ID="btnStep0_OK" runat="server" Text="確定" OnClick="btnStep0_OK_Click">
                                    </dx:ASPxButton>
                                </td>
                                <td>
                                    &nbsp;
                                ...
                                <td>
                                    <dx:ASPxButton ID="btnStep0_Cancel" runat="server" Text="取消" AutoPostBack="false">
        ...
        <div id="divStep1" runat="server" class="checkOutDiv">
            <table>
                ...
                <tr>
                    <td colspan="2" align="center">
                        <dx:ASPxButton ID="btnStep1_OK" runat="server" Text="確定" OnClick="btnStep1_OK_Click">
                        </dx:ASPxButton>
                    </td>
                </tr>
            </table>
        ...
        <div id="divStep2" runat="server" style="display: none">
            <table>
                ...
                <tr>
                    <td colspan="2" align="center">
                        <dx:ASPxButton ID="btnStep2_OK" runat="server" Text="確定">
                        </dx:ASPxButton>
                    </td>
                </tr>
            </table>
