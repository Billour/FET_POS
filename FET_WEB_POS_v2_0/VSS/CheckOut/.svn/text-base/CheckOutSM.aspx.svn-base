    ...
    <div>
        ...
        <table>
            <tr>
                ...
                <td class="tdval">
                    <table cellpadding="0" cellspacing="0" border="0">
                        <tr>
                            <td>
                                <dx:ASPxTextBox ID="TextBox1" runat="server" TextMode="Password">
                                </dx:ASPxTextBox>
                            </td>
                            <td>
                                &nbsp;
                            ...
                            <td>
                                <dx:ASPxButton ID="Button1" runat="server" Text="輸入" OnClick="Button1_Click">
                                </dx:ASPxButton>
                            </td>
                        </tr>
                    </table>
            ...
            <tr>
                ...
                <td class="tdval">
                    <dx:ASPxTextBox ID="TextBox2" runat="server" Enabled="false">
                    </dx:ASPxTextBox>
                </td>
            </tr>
            <tr>
                ...
                <td class="tdval">
                    <dx:ASPxTextBox ID="TextBox3" runat="server" Enabled="false">
                    </dx:ASPxTextBox>
                </td>
            </tr>
                ...
                <ContentTemplate>
                    <tr>
                        ...
                        <td class="tdval">
                            ...
                            <br />
                            <dx:ASPxTextBox ID="TextBox4" runat="server" Enabled="false">
                            </dx:ASPxTextBox>
                        </td>
                    </tr>
                </ContentTemplate>
