<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="PRE01.aspx.cs" Inherits="VSS_PRE01_PRE01" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentPlaceHolder" runat="Server">
    ...
    <div class="SubEditBlock">
        <div class="GridScrollBar" style="height: auto">
            <dx:ASPxGridView ClientInstanceName="gvMaster" ID="gvMaster" runat="server" Width="100%"
                KeyFieldName="商品料號">
                <Columns>
                    ...
                    <dx:GridViewDataColumn HeaderStyle-HorizontalAlign="Center" CellStyle-HorizontalAlign="Left"
                        FieldName="商品料號" Caption="<%$ Resources:WebResources, ProductCode %>" VisibleIndex="1">
                    ...
                    <dx:GridViewDataColumn HeaderStyle-HorizontalAlign="Center" CellStyle-HorizontalAlign="Left"
                        FieldName="商品名稱" Caption="<%$ Resources:WebResources, ProductName %>" VisibleIndex="2">
                        <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                        <CellStyle HorizontalAlign="Left">
                        </CellStyle>
                    </dx:GridViewDataColumn>
                    <dx:GridViewDataColumn HeaderStyle-HorizontalAlign="Center" CellStyle-HorizontalAlign="Left"
                        FieldName="預收款說明" Caption="預收款說明" VisibleIndex="3">
                        <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                        <CellStyle HorizontalAlign="Left">
                        </CellStyle>
                    </dx:GridViewDataColumn>
                    <dx:GridViewDataColumn HeaderStyle-HorizontalAlign="Center" CellStyle-HorizontalAlign="Left"
                        FieldName="預購金額" Caption="<%$ Resources:WebResources, PreOrderAmount %>" VisibleIndex="4">
                        <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                        <CellStyle HorizontalAlign="Left">
                        </CellStyle>
                    </dx:GridViewDataColumn>
                    <dx:GridViewDataColumn HeaderStyle-HorizontalAlign="Center" CellStyle-HorizontalAlign="Left"
                        FieldName="數量" Caption="<%$ Resources:WebResources, Quantity %>" VisibleIndex="5">
                        <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                        <CellStyle HorizontalAlign="Left">
                        </CellStyle>
                    </dx:GridViewDataColumn>
                    <dx:GridViewDataColumn HeaderStyle-HorizontalAlign="Center" CellStyle-HorizontalAlign="Left"
                        FieldName="總價" Caption="<%$ Resources:WebResources, TotalPrice %>" VisibleIndex="6">
                        <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                        <CellStyle HorizontalAlign="Left">
                        </CellStyle>
                    </dx:GridViewDataColumn>
                    <dx:GridViewDataColumn HeaderStyle-HorizontalAlign="Center" CellStyle-HorizontalAlign="Left"
                        FieldName="備註" Caption="<%$ Resources:WebResources, RemarksLimitedTo50Chars %>"
                        VisibleIndex="7">
                        <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                        <CellStyle HorizontalAlign="Left">
                        </CellStyle>
    ...
    <div>
        <div class="SubEditBlock">
            <div class="GridScrollBar" style="height: auto">
                <dx:ASPxGridView ID="gvMaster2" ClientInstanceName="gvMaster2" runat="server" Width="100%"
                    KeyFieldName="付款方式">
                    <Columns>
                        <dx:GridViewCommandColumn ShowSelectCheckbox="True" VisibleIndex="0" HeaderStyle-HorizontalAlign="Center">
                            <HeaderTemplate>
                        ...
                        <dx:GridViewDataColumn HeaderStyle-HorizontalAlign="Center" CellStyle-HorizontalAlign="Left"
                            FieldName="付款方式" Caption="<%$ Resources:WebResources, PaymentMethod %>" VisibleIndex="1" />
                        <dx:GridViewDataColumn HeaderStyle-HorizontalAlign="Center" CellStyle-HorizontalAlign="Left"
                            FieldName="金額" Caption="<%$ Resources:WebResources, Amount %>" VisibleIndex="2" />
                        <dx:GridViewDataColumn HeaderStyle-HorizontalAlign="Center" CellStyle-HorizontalAlign="Left"
                            FieldName="付款明細" Caption="<%$ Resources:WebResources, PaymentStatement %>" VisibleIndex="3" />
                    </Columns>
                    <Templates>
                        <TitlePanel>
                            <table cellpadding="0" cellspacing="0" border="0" align="left">
