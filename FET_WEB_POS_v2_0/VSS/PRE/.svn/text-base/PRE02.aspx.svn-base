<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="PRE02.aspx.cs" Inherits="VSS_PRE02_PRE02" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentPlaceHolder" runat="Server">
    <div class="titlef" align="left">
        <!--預購查詢作業-->
        <asp:Literal ID="Literal1" runat="server" Text="預收款查詢作業"></asp:Literal>
    </div>
    <div class="criteria">
        <table>
            <tr>
                            ...
                            <Templates>
                                ...
                                <TitlePanel>
                                    <table cellpadding="0" cellspacing="0" border="0" align="left">
                                        <tr>
                                            <td align="right">
                                                <dx:ASPxButton ID="btnAdd1" runat="server" Text="匯出" AutoPostBack="false">
                                                </dx:ASPxButton>
                                            </td>
                                        </tr>
                                    </table>
