<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="ORD02.aspx.cs" Inherits="VSS_ORD02_ORD02" %>
        ...
        <div>
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="titlef">
                <tr>
                    ...
                    <td align="right">
                        <dx:ASPxButton ID="ASPxButton1" SkinID="ProductsPopup" runat="server" Text="<%$ Resources:WebResources, OrderPlacement %>"
                            AutoPostBack="False">
                            <ClientSideEvents Click="function(s, e) {
	document.location='ORD01.aspx';return false;
}" />
                        </dx:ASPxButton>
                    </td>
                </tr>
            ...
            <cc:ASPxGridView ID="gvMasterDV" runat="server" ClientInstanceName="gvMasterDV" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn VisibleIndex="3" FieldName="訂單編號" Caption="<%$ Resources:WebResources, OrderNo %>">
                        <DataItemTemplate>
                            <div align="left">
                                <dx:ASPxHyperLink ID="ASPxHyperLink1" runat="server" Text='<%#BIND("訂單編號") %>' NavigateUrl='~/VSS/ORD/ORD01.aspx?OrderNo=SO2101-1007010'>
                                </dx:ASPxHyperLink>
                            </div>
                        </DataItemTemplate>
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn VisibleIndex="4" FieldName="預訂單號" Caption="<%$ Resources:WebResources, PreOrderSheetNo %>">
                        <DataItemTemplate>
                            <div align="left">
                                <dx:ASPxHyperLink ID="ASPxHyperLink1" runat="server" Text='<%#BIND("預訂單號") %>' NavigateUrl='~/VSS/ORD/ORD12.aspx?OrderNo=PR2101-1007011'>
                                </dx:ASPxHyperLink>
                            </div>
                        </DataItemTemplate>
                    </dx:GridViewDataTextColumn>
