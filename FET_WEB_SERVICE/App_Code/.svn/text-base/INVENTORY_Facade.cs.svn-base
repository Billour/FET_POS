...
namespace FET.POS.Model.Facade.FacadeImpl
{
    public class INVENTORY_Facade : BaseClass
    {
        ...
        public void PK_INVENTORY_SHIPCONFIRM(OracleTransaction objTX, string I_SERVICE_TYPE, string I_INV_TRAN_TYPE, string I_PRODNO, string I_STORE_NO, string I_STOCK_ID, string I_SHEET_NO, int I_INV_QTY, string I_USER, ref string O_RT_CODE,
        ref string O_RT_MESSAGE)
        {
            ...
            try
            {
                oraCmd = new OracleCommand("PK_INVENTORY_1.SHIPCONFIRM");
                oraCmd.CommandType = System.Data.CommandType.StoredProcedure;
                oraCmd.Parameters.Add(new OracleParameter("I_SERVICE_TYPE", OracleType.VarChar, 2000)).Value = I_SERVICE_TYPE;
                oraCmd.Parameters.Add(new OracleParameter("I_INV_TRAN_TYPE", OracleType.VarChar, 2000)).Value = I_INV_TRAN_TYPE;
        ...
        public void PK_INVENTORY_SHIPACCEPT(OracleTransaction objTX, string I_SERVICE_TYPE, string I_INV_TRAN_TYPE, string I_PRODNO, string I_STORE_NO, string I_STOCK_ID, string I_SHEET_NO, int I_INV_QTY, string I_USER, ref string O_RT_CODE,
        ref string O_RT_MESSAGE)
        {
            OracleCommand oraCmd = null;
        ...
        public void PK_INVENTORY_REJECTINVENTORY(OracleTransaction objTX, string I_SERVICE_TYPE, string I_INV_TRAN_TYPE, string I_PRODNO, string I_STORE_NO, string I_STOCK_ID, string I_SHEET_NO, int I_INV_QTY, string I_USER, ref string O_RT_CODE,
        ref string O_RT_MESSAGE)
        {
            OracleCommand oraCmd = null;
        ...
        public void PK_INVENTORY_RETURN(OracleTransaction objTX, string I_SERVICE_TYPE, string I_PRODNO, string I_STORE_NO, string I_STOCK_ID, string I_SHEET_NO, int I_INV_QTY, string I_USER, ref string O_RT_CODE,
        ref string O_RT_MESSAGE)
        {
            OracleCommand oraCmd = null;
        ...
        public void PK_INVENTORY_SHIFTSTOCK(OracleTransaction objTX, string I_SERVICE_TYPE, string I_INV_TRAN_TYPE, string I_PRODNO, string I_STORE_NO, string I_STOCK_ID, string I_SHEET_NO, int I_INV_QTY, string I_USER, ref string O_RT_CODE,
        ref string O_RT_MESSAGE)
        {
            OracleCommand oraCmd = null;
        ...
        public void PK_INVENTORY_ADJUST(OracleTransaction objTX, string I_SERVICE_TYPE, string I_INV_TRAN_TYPE, string I_PRODNO, string I_STORE_NO, string I_STOCK_ID, string I_SHEET_NO, int I_INV_QTY, string I_USER, ref string O_RT_CODE,
        ref string O_RT_MESSAGE)
        {
            OracleCommand oraCmd = null;
        ...
        public void PK_INVENTORY_MAKEANINVENTORY(OracleTransaction objTX, string I_SERVICE_TYPE, string I_INV_TRAN_TYPE, string I_PRODNO, string I_STORE_NO, string I_STOCK_ID, string I_SHEET_NO, int I_INV_QTY, string I_USER, ref string O_RT_CODE,
        ref string O_RT_MESSAGE)
        {
            OracleCommand oraCmd = null;
        ...
        //public void PK_INVENTORY_TRANSFER(OracleConnection objConn, string I_SERVICE_TYPE, string I_INV_TRAN_TYPE, string I_PRODNO, string I_STORE_NO, string I_STOCK_ID, string I_SHEET_NO, int I_INV_QTY, string I_USER, ref string O_RT_CODE,
        //ref string O_RT_MESSAGE)

         public void PK_INVENTORY_TRANSFER(OracleTransaction objTX, string I_SERVICE_TYPE, string I_INV_TRAN_TYPE, string I_PRODNO, string I_STORE_NO, string I_STOCK_ID, string I_SHEET_NO, int I_INV_QTY, string I_USER, ref string O_RT_CODE,
        ref string O_RT_MESSAGE)
        {
            OracleCommand oraCmd = null;
         ...
         public void PK_INVENTORY_COLLARUSE(OracleTransaction objTX, string I_SERVICE_TYPE, string I_INV_TRAN_TYPE, string I_PRODNO, string I_STORE_NO, string I_STOCK_ID, string I_SHEET_NO, int I_INV_QTY, string I_USER, ref string O_RT_CODE,
        ref string O_RT_MESSAGE)
        {
            OracleCommand oraCmd = null;
