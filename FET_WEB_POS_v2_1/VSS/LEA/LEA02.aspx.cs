...
public partial class VSS_LEA_LEA02 : BasePage
{
    ...
    protected void detailGrid_BeforeColumnSortingGrouping(object sender, DevExpress.Web.ASPxGridView.ASPxGridViewBeforeColumnGroupingSortingEventArgs e)
    {
    ...
    protected void gvMaster_HtmlRowCreated(object sender, DevExpress.Web.ASPxGridView.ASPxGridViewTableRowEventArgs e)
    {
        if (e.RowType == GridViewRowType.Detail)
        {
            ...
            detailGrid.DataSource = getData2("台中", "手機類型2");
            detailGrid.DataBind();
        }
