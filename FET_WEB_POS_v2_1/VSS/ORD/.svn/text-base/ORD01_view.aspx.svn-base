<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="ORD01_view.aspx.cs" Inherits="VSS_ORD_ORD01_view" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentPlaceHolder" runat="Server">
    <div>
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="titlef">
            <tr>
                <td align="left">
                    <asp:Literal ID="Literal1" runat="server" Text="<%$ Resources:WebResources, OrderDetail %>"></asp:Literal>
                </td>
                <td align="right">
            ...
            <div id="divContent" runat="server" class="SubEditBlock">
                <cc:ASPxGridView ID="drMasterDV" Width="100%" runat="server" ClientInstanceName="drMasterDV"
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="4" FieldName="建議訂購量" Caption="<%$ Resources:WebResources, OrderQuantity %>"
                            CellStyle-HorizontalAlign="Right">
                            <CellStyle HorizontalAlign="Right">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn VisibleIndex="5" FieldName="總部核准量" Caption="<%$ Resources:WebResources, ApprovedTheAmount %>"
                            CellStyle-HorizontalAlign="Right">
                            <CellStyle HorizontalAlign="Right">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn VisibleIndex="6" FieldName="驗收量" Caption="<%$ Resources:WebResources, InspectionQuantity %>"
                            CellStyle-HorizontalAlign="Right">
                            <CellStyle HorizontalAlign="Right">
                            </CellStyle>
                        </dx:GridViewDataTextColumn>
