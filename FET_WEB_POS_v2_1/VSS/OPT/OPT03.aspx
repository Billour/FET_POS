...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentPlaceHolder" runat="Server">
    ...
    <div class="criteria">
        <table>
            <tr>
                ...
                <td class="tdval">
                    <dx:ASPxComboBox ID="ddlCardBank" runat="server" SelectedIndex="0">
                    </dx:ASPxComboBox>
                </td>
                <td class="tdtxt">
                    <!--成本中心-->
    ...
    <cc:ASPxGridView ID="gvMaster" ClientInstanceName="gvMaster" runat="server" KeyFieldName="項次"
        Settings-ShowTitlePanel="true" Width="100%" OnRowInserting="gvMaster_RowInserting"
        OnHtmlRowCreated="grid_HtmlRowCreated" OnPageIndexChanged="grid_PageIndexChanged"
        OnRowUpdating="gvMaster_RowUpdating" OnHtmlDataCellPrepared="gvMaster_HtmlDataCellPrepared"
        EnableCallBacks="False" OnFocusedRowChanged="gvMaster_FocusedRowChanged">
        <Columns>
            ...
            <dx:GridViewDataComboBoxColumn FieldName="發卡銀行" runat="server" Caption="發卡銀行" VisibleIndex="4">
                ...
                <HeaderCaptionTemplate>
                    ...
                    <dx:ASPxLabel ID="Literal7" runat="server" Text="發卡銀行">
                    </dx:ASPxLabel>
                </HeaderCaptionTemplate>
            ...
            <dx:GridViewDataTextColumn FieldName="分期期數" runat="server" Caption="分期期數" VisibleIndex="5">
                <HeaderCaptionTemplate>
                    <span style="color: Red">*</span>
                    <dx:ASPxLabel ID="Literal7" runat="server" Text="分期期數">
                    </dx:ASPxLabel>
                </HeaderCaptionTemplate>
                <EditItemTemplate>
            ...
            <dx:GridViewDataTextColumn FieldName="分期利率" runat="server" Caption="分期利率" VisibleIndex="6"
                ...
                <HeaderCaptionTemplate>
                    <span style="color: Red">*</span>
                    <dx:ASPxLabel ID="Literal7" runat="server" Text="分期利率">
                    </dx:ASPxLabel>
                </HeaderCaptionTemplate>
                <PropertiesTextEdit>
                    <ReadOnlyStyle>
    ...
    <div id="Div2" style="text-align: left;" visible="false">
        ...
        <cc:ASPxGridView ID="gvDetail" ClientInstanceName="gvDetail" runat="server" Width="40%"
            Settings-ShowTitlePanel="true" KeyFieldName="項次" Visible="false" OnHtmlRowCreated="grid_HtmlRowCreated"
            OnPageIndexChanged="grid_PageIndexChanged" OnRowUpdating="gvDetail_RowUpdating"
            ...
            <Columns>
                ...
                <dx:GridViewDataComboBoxColumn FieldName="成本中心" runat="server" Caption="<%$ Resources:WebResources, CostCenter %>"
                    VisibleIndex="4" Width="80px">
                    <HeaderCaptionTemplate>
                        <span style="color: Red">*</span>
                        <dx:ASPxLabel ID="Literal7" runat="server" Text="<%$ Resources:WebResources, CostCenter %>">
                        </dx:ASPxLabel>
                    </HeaderCaptionTemplate>
                    <EditItemTemplate>
                ...
                <dx:GridViewDataTextColumn FieldName="成本中心拆帳比率" runat="server" Caption="<%$ Resources:WebResources, CostCenterSplitOffRatio %>"
                    VisibleIndex="5" Width="60px" HeaderStyle-HorizontalAlign="Left">
                    <HeaderCaptionTemplate>
                        <span style="color: Red">*</span>
                        <dx:ASPxLabel ID="Literal7" runat="server" Text="<%$ Resources:WebResources, CostCenterSplitOffRatio %>">
                        </dx:ASPxLabel>
                    </HeaderCaptionTemplate>
                    <EditItemTemplate>
