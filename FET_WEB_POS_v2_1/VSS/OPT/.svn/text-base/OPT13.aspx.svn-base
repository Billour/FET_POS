<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="OPT13.aspx.cs" Inherits="VSS_OPT_OPT13" %>
...
<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                        ...
                        <dx:GridViewDataTextColumn FieldName="折抵次數" Caption="<%$ Resources:WebResources, RedeemingFrequency %>">
                        </dx:GridViewDataTextColumn>
                        ...
                        <EditForm>
                            <table width="90%">
                                ...
                                <tr>
                                    ...
                                    <%--折抵次數--%>
                                    <td class="tdtxt" nowrap="nowrap">
                                        <asp:Literal ID="Literal8" runat="server" Text="折抵次數"></asp:Literal>：
                                    </td>
                                    <td class="tdval" nowrap="nowrap">
                                        <dx:ASPxTextBox ID="ASPxTextBox3" runat="server" Width="100%" Text='<%# Eval("折抵次數") %>'>
                                        </dx:ASPxTextBox>
                                    </td>
                                </tr>
                            </table>
