...
public partial class VSS_OPT_OPT12 : BasePage
{
    ...
    protected void bindEmptyData()
    {
        ...
        dtResult.Columns.Add("累點代號", typeof(string));
        dtResult.Columns.Add("累點金額", typeof(int));
        dtResult.Columns.Add("累點名稱", typeof(string));
        dtResult.Columns.Add("開始日期", typeof(DateTime));
        dtResult.Columns.Add("結束日期", typeof(string));
        dtResult.Columns.Add("更新人員", typeof(string));
        dtResult.Columns.Add("更新日期", typeof(string));
        dtResult.Columns.Add("累點點數", typeof(int));
    ...
    private DataTable GetMasterData()
    {
        ...
        dtMaster.Columns.Add("累點金額", typeof(int));
        ...
        dtMaster.Columns.Add("累點點數", typeof(int));

        int[] ary1 = { 50, 100, 500, 1000, 2000, 3000 };
        string[] ary2 = { "800000003", "800000003", "800000003", "800000003", "800000003", "800000003", "800000004", "800000004" };
        ...
        for (int i = 1; i < 12; i++)
        {
            ...
            dtMasterRow["開始日期"] = DateTime.Today.Date.AddDays(-20);
