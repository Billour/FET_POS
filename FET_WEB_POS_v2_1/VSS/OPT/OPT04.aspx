    ...
    <div>
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="titlef">
            <tr>
                <td align="left">
                    <!--禮券設定作業-->
                    <asp:Literal ID="Literal2" runat="server" Text="<%$ Resources:WebResources, CouponSetting %>"></asp:Literal>
                </td>
            </tr>
        </table>
    </div>
    <div>
        ...
        <cc:ASPxGridView ID="gvMaster" ClientInstanceName="gvMaster" runat="server" KeyFieldName="項次"
            ...
            <Columns>
                ...
                <dx:GridViewDataComboBoxColumn FieldName="禮券名稱" runat="server" Caption="<%$ Resources:WebResources, CouponName %>" VisibleIndex="5">
                    <EditItemTemplate>
                ...
                <dx:GridViewDataComboBoxColumn FieldName="是否輸入禮券序號" runat="server" Caption="<%$ Resources:WebResources, EnterCouponNumber %>"
                    VisibleIndex="7">
                    <EditItemTemplate>
                ...
                <dx:GridViewDataDateColumn FieldName="開始日期" runat="server" ReadOnly="true" Caption="<%$ Resources:WebResources, StartDate %>"
                    VisibleIndex="7">
                    <PropertiesDateEdit>
