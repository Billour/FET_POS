<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProductType.aspx.cs" Inherits="VSS_Common_ProductType" %>
    ...
    <div class="func">
        <div>
            <div class="criteria">
                <table>                    
                    <tr>
                        <td class="tdtxt">                            
                            <!--類型名稱-->
                            <asp:Literal ID="Literal1" runat="server" Text="類型名稱"></asp:Literal>：
                        </td>
                        <td class="tdval">
            ...
            <div class="seperate"></div>                             
             <cc:ASPxGridView ID="grid" ClientInstanceName="grid" runat="server" KeyFieldName="類型名稱" Width="100%"              
                ...
                <Columns>   
                    ...
                    <dx:GridViewDataColumn FieldName="類型名稱" Caption="<%$ Resources:WebResources, CategoryName %>" />                                    
                </Columns>
