    ...
    <div class="func">
        <div>
            ...
            <div class="seperate"></div>                             
             <cc:ASPxGridView ID="grid" ClientInstanceName="grid" runat="server" KeyFieldName="類別編號" Width="100%"              
                ...
                <Columns>   
                    ...
                    <dx:GridViewDataColumn FieldName="類別編號" Caption="<%$ Resources:WebResources, CategoryNo %>" />
                    <dx:GridViewDataColumn FieldName="類別名稱" Caption="<%$ Resources:WebResources, CategoryName %>" />                                    
                </Columns>
