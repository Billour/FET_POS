...
public partial class VSS_Common_ProductType : Popup
{
    ...
    private DataTable GetMasterData()
    {
        ...
        dtResult.Columns.Add("類型名稱", typeof(string));

        string[] array1 = { "10", "11", "15", "20", "30" };
        string[] array2 = { "Nokia", "Sony Ericsson", "LG", "Apple", "BenQ", "Samsung" };
