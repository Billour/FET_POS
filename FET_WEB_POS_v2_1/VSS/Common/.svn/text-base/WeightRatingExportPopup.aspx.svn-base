<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WeightRatingExportPopup.aspx.cs" Inherits="VSS_Common_WeightRatingExportPopup" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>權重佔比分配檔匯出</title>
</head>
<body>
                ...
                <ContentTemplate>
                    ...
                    <cc:ASPxGridView ID="gvMaster" runat="server" ClientInstanceName="gvMaster"
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataTextColumn VisibleIndex="4" FieldName="主動配貨" Caption="<%$ Resources:WebResources, ActivePicking %>">
                            </dx:GridViewDataTextColumn>
                ...
                <asp:UpdatePanel ID="UpdatePanel2" runat="server" RenderMode="Inline">
                    <ContentTemplate>
                        <table align="center">
                            <tr>
                                <td>
                                    <dx:ASPxButton ID="btnUpdate" Visible="false" runat="server" Text="<%$ Resources:WebResources, CommitUpload %>"  
                                        AutoPostBack="False" >
