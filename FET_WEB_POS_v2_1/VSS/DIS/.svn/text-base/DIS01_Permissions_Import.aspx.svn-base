<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DIS01_Permissions_Import.aspx.cs" Inherits="VSS_DIS_DIS01_Permissions_Import" %>
...
<body>
    ...
    <div class="func">
        ...
        <cc:ASPxGridView ID="gvProduct" ClientInstanceName="gvProduct" runat="server" KeyFieldName="促銷代號"
            Width="100%" AutoGenerateColumns="False" OnHtmlRowPrepared="gvProduct_HtmlRowPrepared">
            
            <Columns>
                <dx:GridViewDataTextColumn FieldName="促銷代號" runat="server" ReadOnly="true" Caption="<%$ Resources:WebResources, PromotionCode %>"
                    VisibleIndex="0">
                    <PropertiesTextEdit>
                        <ReadOnlyStyle>
                ...
                <dx:GridViewDataTextColumn FieldName="促銷名稱" runat="server" ReadOnly="True" Caption="<%$ Resources:WebResources, PromotionName %>"
                    VisibleIndex="1">
                    <PropertiesTextEdit>
                        <ReadOnlyStyle>
                            <Border BorderStyle="None" />
