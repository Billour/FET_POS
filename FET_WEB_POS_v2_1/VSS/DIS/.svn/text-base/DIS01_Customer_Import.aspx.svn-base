<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DIS01_Customer_Import.aspx.cs" Inherits="VSS_DIS_DIS01_Customer_Import" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>客戶對應名單上傳</title>
</head>
<body>
    ...
    <div class="func">
        ...
        <cc:ASPxGridView ID="gvProduct" ClientInstanceName="gvProduct" runat="server" KeyFieldName="客戶門號"
            Width="100%" AutoGenerateColumns="False" OnHtmlRowPrepared="gvProduct_HtmlRowPrepared">
            
            <Columns>
                <dx:GridViewDataTextColumn FieldName="客戶門號" runat="server" ReadOnly="true" Caption="<%$ Resources:WebResources, PromotionCode %>"
                    VisibleIndex="0">
                    <PropertiesTextEdit>
                        <ReadOnlyStyle>
