...
public partial class VSS_CHK_CHK06 : BasePage
{
    ...
    private DataTable GetEmptyDataTable()
    {
        ...
        dtResult.Columns.Add("合庫入帳", typeof(int));
        dtResult.Columns.Add("POS現金帳", typeof(int));
        dtResult.Columns.Add("NCCC信用卡入帳", typeof(int));
        dtResult.Columns.Add("POS信用卡帳", typeof(int));
    ...
    private DataTable getMasterData()
    {
        ...
        for (int i = 0; i < 3; i++)
        {
            ...
            NewRow["合庫入帳"] = int.Parse( TotalPay[i % 3], NumberStyles.AllowThousands);
            NewRow["POS現金帳"] = int.Parse(PosCash[i % 3], NumberStyles.AllowThousands);
            NewRow["NCCC信用卡入帳"] = int.Parse( NcccCredit[i % 3], NumberStyles.AllowThousands);
            NewRow["POS信用卡帳"] = int.Parse(PosCredit[i % 3], NumberStyles.AllowThousands);
    ...
    private DataTable getDetailData()
    {
        ...
        gvDetail.Columns.Add("合庫入帳", typeof(int));
        gvDetail.Columns.Add("POS現金帳", typeof(int));
        gvDetail.Columns.Add("NCCC信用卡入帳", typeof(int));
        gvDetail.Columns.Add("POS信用卡帳", typeof(int));
        ...
        string[] TotalPay = { "103,121", "201,000", "101,122", "0", "0", "128,000", "0", "111,220", "290,001", "123,456" };

        string[] PosCash = { "104,121", "201,000", "0", "0", "111,000", "128,000", "311,000", "0", "290,001", "0" };
        string[] NcccCredit = { "105,121", "195,000", "0", "100,000", "0", "211,000", "0", "60,000", "50,000", "246,801" };
        string[] PosCredit = { "105,121", "185,000", "0", "0", "211,000", "228,000", "251,000", "60,000", "0", "0" };
        ...
        for (int i = 0; i < 10; i++)
        {
            ...
            gvDetailRow["合庫入帳"] = int.Parse(TotalPay[i % 10], NumberStyles.AllowThousands);
            gvDetailRow["POS現金帳"] = int.Parse(PosCash[i % 10], NumberStyles.AllowThousands);
            gvDetailRow["NCCC信用卡入帳"] = int.Parse(NcccCredit[i % 10], NumberStyles.AllowThousands);
            gvDetailRow["POS信用卡帳"] = int.Parse(PosCredit[i % 10], NumberStyles.AllowThousands);
