<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CHK01.aspx.cs" Inherits="VSS_CHK_CHK01" MasterPageFile="~/MasterPage.master" %>
        ...
        <div class="criteria">
            <table>
                ...
                <tr>
                    ...
                    <td class="tdval">
                        <dx:ASPxTextBox ID="TextBox4" runat="server" HorizontalAlign="Right"></dx:ASPxTextBox>
                    </td>
                    <td class="tdtxt">
                        &nbsp;
                    </td>
                ...
                <tr>
                    ...
                    <td class="tdval">
                        <dx:ASPxTextBox ID="TextBox5" runat="server" HorizontalAlign="Right"></dx:ASPxTextBox>
                    </td>
                    <td class="tdtxt">
                        &nbsp;
                    </td>
                ...
                <tr>
                    ...
                    <td class="tdval">
                        <dx:ASPxTextBox ID="TextBox6" runat="server" HorizontalAlign="Right"></dx:ASPxTextBox>
                    </td>
                    <td class="tdtxt">
                        &nbsp;
                    </td>
                ...
                <tr>
                    ...
                    <td class="tdval">
                        <dx:ASPxTextBox ID="TextBox7" runat="server" HorizontalAlign="Right"></dx:ASPxTextBox>
                    </td>
                    <td class="tdtxt">
                        &nbsp;
                    </td>
                ...
                <tr>
                    ...
                    <td class="tdval">
                        <dx:ASPxTextBox ID="TextBox8" runat="server" HorizontalAlign="Right"></dx:ASPxTextBox>
                    </td>
                    <td class="tdtxt">
                    </td>
                    <td class="tdval">
