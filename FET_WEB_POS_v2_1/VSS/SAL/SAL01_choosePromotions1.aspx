<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SAL01_choosePromotions1.aspx.cs"
    Inherits="VSS_SAL_SAL01_choosePromotions1" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>
        <asp:Literal ID="Literal11" runat="server" Text="<%$ Resources:WebResources, SelectPromotionProduct %>" />
    </title>
    ...
    <script type="text/javascript">
        ...
        function OnInit1(s, e) {
            s.GetInputElement().name = "radioChoose1";
        }
    </script>
</head>
<body>
        ...
        <div>
            ...
            <dx:ASPxPageControl ID="ASPxPageControl1" runat="server" Width="100%">
                <TabPages>
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel2" runat="server" RenderMode="Inline">
                                        <ContentTemplate>
                                            <asp:Button ID="btnCommit" runat="server" Text="<%$ Resources:WebResources, Ok %>"
                                                Visible="false" OnClientClick="window.close();return false;" />
                                            <asp:Button ID="btnCalcel" runat="server" Text="<%$ Resources:WebResources, Cancel %>"
                                                Visible="false" OnClientClick="window.close();return false;" />
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </div>
                    ...
                    <dx:TabPage Text="PV Team">
                        <ContentCollection>
                            <dx:ContentControl>
                                <asp:UpdatePanel ID="UpdatePanel3" runat="server" RenderMode="Inline">
                                    <ContentTemplate>
                                        <dx:ASPxGridView ID="gvPVTEAM" runat="server" ClientInstanceName="gvPVTEAM" AutoGenerateColumns="False"
                                            Width="100%">
                                            <Columns>
                                                <dx:GridViewDataDateColumn VisibleIndex="0" Caption="">
                                                    <DataItemTemplate>
                                                        <dx:ASPxRadioButton ID="radioChoose1" runat="server" ClientInstanceName="rc2" GroupName="radioChoose1"
                                                            AutoPostBack="true" OnCheckedChanged="radioChoose1_CheckedChanged">
                                        ...
                                        <table border="0" id="productDetail1" runat="server" style="display: none" width="90%"
                                            align="center">
                                            <tr style="background-color: #780C0C; color: White; text-align: center">
                                                <td>
                                                </td>
                                                <td>
                                                    <!--商品編號-->
                                                    <asp:Literal ID="Literal7" runat="server" Text="<%$ Resources:WebResources, ProductCode %>" />
                                                </td>
                                                <td>
                                                    <!--商品名稱-->
                                                    <asp:Literal ID="Literal8" runat="server" Text="<%$ Resources:WebResources, ProductName %>" />
                                                </td>
                                                <td>
                                                    <!--庫存量-->
                                                    <asp:Literal ID="Literal9" runat="server" Text="<%$ Resources:WebResources, StockQuantity %>" />
                                                </td>
                                                <td>
                                                    <!--價格-->
                                                    <asp:Literal ID="Literal10" runat="server" Text="<%$ Resources:WebResources, Price %>" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                ...
                                <div class="btnPosition">
                                    <asp:UpdatePanel ID="UpdatePanel4" runat="server" RenderMode="Inline">
                                        <ContentTemplate>
                                            <asp:Button ID="btnCommit1" runat="server" Text="<%$ Resources:WebResources, Ok %>"
                                                Visible="false" OnClientClick="window.close();return false;" />
                                            <asp:Button ID="btnCalcel1" runat="server" Text="<%$ Resources:WebResources, Cancel %>"
                                                Visible="false" OnClientClick="window.close();return false;" />
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </div>
