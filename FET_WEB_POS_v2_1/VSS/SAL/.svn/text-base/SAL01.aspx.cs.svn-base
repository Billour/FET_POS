...
public partial class VSS_SAL_SA01 : BasePage
{
   ...
   protected void btnOrderCheckOut_Click(object sender, EventArgs e)
   {
      ...
      PrintPopup.ShowOnPageLoad = true;
   }
   ...
   protected void gvMaster_HtmlRowCreated(object sender, DevExpress.Web.ASPxGridView.ASPxGridViewTableRowEventArgs e)
   {
      if (e.RowType == GridViewRowType.Data)
      {
         ...
         //button status
        // ASPxButton btnIMEI = (ASPxButton)gvMaster.FindRowCellTemplateControl(e.VisibleIndex, (GridViewDataColumn)gvMaster.Columns[9], "Button2");
         PopupControl pControl = e.Row.FindChildControl<PopupControl>("PopupControl2");
