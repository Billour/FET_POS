<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeFile="SAL02.aspx.cs" Inherits="VSS_SAL_SA02" %>
    ...
    <div>
        <div class="func1">
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="titlef">
                <tr>
                    ...
                    <td align="right">
                        <dx:ASPxButton ID="Button3" runat="server" Text="<%$ Resources:WebResources, Selling %>"
                            AutoPostBack="false">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td class="tdval">
                        <dx:ASPxComboBox ID="ASPxComboBox3" runat="server" ValueType="System.String" AutoResizeWithContainer="true">
                            <Items>
                                <dx:ListEditItem Text="ALL" Value="ALL" />
                                <dx:ListEditItem Text="已結帳" Value="已結帳" />
                                <dx:ListEditItem Text="已作廢" Value="已作廢" Selected="true" />
                            </Items>
                        </dx:ASPxComboBox>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="tdval">
                        <uc1:PopupControl ID="PopupControl3" runat="server" PopupControlName="DiscountNoPopup" />
                    ...
                    <td class="tdval">
                        <dx:ASPxComboBox ID="ASPxComboBox2" runat="server" ValueType="System.String" AutoResizeWithContainer="true"
                            SelectedIndex="0">
                            <Items>
                            ...
                            <tr>
                                ...
                                <td>
                                    <dx:ASPxButton ID="Button9" runat="server" Text="<%$ Resources:WebResources, Choose %>"
                                        SkinID="PopupButton" AutoPostBack="false">
                                        <ClientSideEvents Click="function(s,e){openwindow('../SAL/SAL01_searchProductNo.aspx',450,350);return false;}" />
                                    </dx:ASPxButton>
                                </td>
                            </tr>
                        </table>--%>
        ...
        <div class="btnPosition" id="showFooter" runat="server" visible="true">
            <table cellpadding="0" cellspacing="0" border="0" align="center">
                <tr>
                    <td>
                        <dx:ASPxButton ID="Button1" runat="server" Text="<%$ Resources:WebResources, View %>" CommandName="View">
                        </dx:ASPxButton>
                    </td>
                    <td>
                        &nbsp;
