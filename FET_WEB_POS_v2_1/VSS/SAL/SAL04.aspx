    ...
    <div class="func1">
        ...
        <div class="criteria">
            <table>
                ...
                <tr>
                    ...
                    <td class="tdtxt" nowrap="nowrap">
                        <!--日期-->
                        <asp:Literal ID="Literal7" runat="server" Text="<%$ Resources:WebResources, ModifiedDate %>" />：
                    </td>
                    <td class="tdval">
                        2010/06/18 16:00
                    </td>
                ...
                <tr>
                    ...
                    <td class="tdtxt" nowrap="nowrap">
                        <!--作廢備註-->
                        <asp:Literal ID="Literal30" runat="server" Text="<%$ Resources:WebResources, CancelRemark %>" />：
                    </td>
                    <td>
        ...
        <div class="btnPosition">
            <table cellpadding="0" cellspacing="0" border="0" align="center">
                <tr>
                    <td>
                        <dx:ASPxButton ID="btnVoid" runat="server" Text="<%$ Resources:WebResources, ConfirmCancel %>" OnClick="btnVoid_Click">
                        </dx:ASPxButton>
                    </td>
                </tr>
            </table>
