...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentPlaceHolder" runat="Server">
    <div>
        ...
        <div>
            <table style="width: 100%">
                <tr>
                    ...
                    <td class="tdval">
                        ...
                        <%--<table cellpadding="0" cellspacing="0" border="0">
                            <tr>
                                <td>
                                    <dx:ASPxTextBox ID="TextBox8" runat="server" Width="100px" />
                                </td>
                                <td>
                                    &nbsp;
                                </td>
                    ...
                    <td class="tdval">
                        ...
                        <%--<table cellpadding="0" cellspacing="0" border="0">
                            <tr>
                                ...
                                <td>
                                    <dx:ASPxButton ID="chooseButton2" runat="server" SkinID="PopupButton" Text="<%$ Resources:WebResources, Choose %>">
                                    </dx:ASPxButton>
                                </td>
                            </tr>
                        </table>--%>
                ...
                <tr>
                    ...
                    <td class="tdval">
                        <uc1:PopupControl ID="PopupControl3" runat="server" PopupControlName="StoresPopup"  />
        ...
        <cc:ASPxGridView ID="grid" ClientInstanceName="grid" runat="server" KeyFieldName="移撥單號"
                ...
                <DetailRow>
                    <cc:ASPxGridView ID="detailGrid" runat="server" ClientInstanceName="detailGrid" Settings-ShowTitlePanel="true"
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataColumn FieldName="移出IMEI" Caption="<%$ Resources:WebResources, TransferOutImei %>" />
                            <dx:GridViewDataColumn FieldName="撥入數量" Caption="<%$ Resources:WebResources, TransferredInQuantity %>" />
                            <dx:GridViewDataColumn FieldName="撥入IMEI" Caption="<%$ Resources:WebResources, TransferInImei %>" />
                        </Columns>
...
<%--    <cc:ASPxPopupControl ID="productsPopup" SkinID="ProductsPopup" runat="server" EnableViewState="False"
        PopupElementID="chooseButton1" TargetElementID="TextBox8" LoadingPanelID="lp1">
    </cc:ASPxPopupControl>
    <cc:ASPxPopupControl ID="storesPopup1" SkinID="StoresPopup" runat="server" EnableViewState="False"
        PopupElementID="chooseButton2" TargetElementID="TextBox4" LoadingPanelID="lp1">
    </cc:ASPxPopupControl>
    <cc:ASPxPopupControl ID="storesPopup2" ClientInstanceName="StoresPopup" SkinID="StoresPopup"
        runat="server" EnableViewState="False" PopupElementID="ASPxButton1" TargetElementID="TextBox2"
        LoadingPanelID="lp1">
    </cc:ASPxPopupControl>
