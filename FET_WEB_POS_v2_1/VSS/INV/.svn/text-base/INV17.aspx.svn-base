    ...
    <div>
        ...
        <cc:ASPxGridView ID="gvMaster" ClientInstanceName="gvMaster" runat="server" KeyFieldName="關帳年月"
            ...
            <Columns>
                ...
                <dx:GridViewDataTextColumn FieldName="關帳年月" runat="server" Caption="<%$ Resources:WebResources, ClosingYearMonth %>" VisibleIndex="2">
                ...
                <dx:GridViewDataTextColumn FieldName="關帳日" runat="server" Caption="<%$ Resources:WebResources, ClosingDate %>" VisibleIndex="3">
                    <CellStyle HorizontalAlign="Left">
                    </CellStyle>
                    <EditCellStyle HorizontalAlign="Left" />
                    <EditItemTemplate>
