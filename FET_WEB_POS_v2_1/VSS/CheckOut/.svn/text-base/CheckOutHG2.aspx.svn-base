        ...
        <div>
            <asp:Wizard ID="Wizard1" runat="server" OnNextButtonClick="Wizard1_NextButtonClick"
                ...
                <StartNavigationTemplate>
                    <dx:ASPxButton ID="Button1" runat="server" Text="<%$ Resources:WebResources, Ok %>" CommandName="MoveNext">
                    </dx:ASPxButton>
                </StartNavigationTemplate>
                <StepNavigationTemplate>
                    <table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td>
                                <dx:ASPxButton ID="Button1" runat="server" Text="下一步" CommandName="MoveNext">
                                </dx:ASPxButton>
                            </td>
                            <td>&nbsp;</td>
                            <td>
                                <dx:ASPxButton ID="Button2" runat="server" Text="<%$ Resources:WebResources, Cancel %>" CommandName="CloseWin" AutoPostBack="false">
                ...
                <FinishNavigationTemplate>
                    <table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <td>&nbsp;</td>
                            <td>
                                <dx:ASPxButton ID="btnFinClose" runat="server" Text="<%$ Resources:WebResources, Cancel %>" CommandName="CloseWin" AutoPostBack="false" >
                                    <ClientSideEvents Click="function(s,e){window.close();}" />
                                </dx:ASPxButton>
                            </td>
                        </tr>
