        ...
        <div>
            <asp:Wizard ID="Wizard1" runat="server" OnNextButtonClick="Wizard1_NextButtonClick"
                ...
                <StartNavigationTemplate>
                    <dx:ASPxButton ID="btnStart" runat="server" Text="<%$ Resources:WebResources, Ok %>" CommandName="MoveNext">
                    </dx:ASPxButton>
                </StartNavigationTemplate>
                <StepNavigationTemplate>
                    <table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td>
                                <dx:ASPxButton ID="btnNext" runat="server" Text="<%$ Resources:WebResources, Ok %>" CommandName="MoveNext" AutoPostBack="false">
                                <ClientSideEvents Click="function(s,e){window.close();}" />
                                </dx:ASPxButton>
                            </td>
                            <td>&nbsp;</td>
                            <td>
                                <dx:ASPxButton ID="btnClose" runat="server" Text="<%$ Resources:WebResources, Cancel %>" CommandName="CloseWin" AutoPostBack="false">
                                    <ClientSideEvents Click="function(s,e){window.close();}" />
                                </dx:ASPxButton>
                            </td>
                            <td>&nbsp;</td>
                            <td>
                                <dx:ASPxButton ID="btnReset" runat="server" Text="<%$ Resources:WebResources, Reset %>" AutoPostBack="false"></dx:ASPxButton>
                            </td>
                        </tr>
                    </table>
                </StepNavigationTemplate>
...
--%>                            </td>
                ...
                <FinishNavigationTemplate>
                    <table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td>
                                <dx:ASPxButton ID="btnPre" runat="server" Text="上一步" CommandName="MovePrevious" Visible="false"></dx:ASPxButton>
                            </td>
                            <td>&nbsp;</td>
                            <td>
                            ...
                            <td>&nbsp;</td>
                            <td>
                                <dx:ASPxButton ID="btnFinClose" runat="server" Text="<%$ Resources:WebResources, Cancel %>" CommandName="CloseWin" AutoPostBack="false" Visible="false">
                                    <ClientSideEvents Click="function(s,e){window.close();}" />
                                </dx:ASPxButton>
                            </td>
                        </tr>
