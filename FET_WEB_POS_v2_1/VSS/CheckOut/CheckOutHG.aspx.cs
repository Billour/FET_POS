...
public partial class VSS_CheckOut_CheckOutHG : BasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            {
                ASPxButton btnNext = this.Wizard1.FindChildControl<ASPxButton>("btnNext");
                ASPxButton btnClear = this.Wizard1.FindChildControl<ASPxButton>("btnReset");
                ASPxButton btnPre = this.Wizard1.FindChildControl<ASPxButton>("btnPre");
                ASPxButton btnFinClose = this.Wizard1.FindChildControl<ASPxButton>("btnFinClose");

                GridView1.Visible = GridView2.Visible = gvMaster.Settings.ShowTitlePanel = btnClear.Visible = false;
                btnPre.Visible = btnFinClose.Visible = true;

                this.ASPxLabel1.Text = "請過卡兌點";
                btnNext.Text = "下一步";
            }
