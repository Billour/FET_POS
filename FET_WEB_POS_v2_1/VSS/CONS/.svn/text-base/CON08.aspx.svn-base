<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="CON08.aspx.cs" Inherits="VSS_CONS_CON08" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentPlaceHolder" Runat="Server">   
                ...
                EnableRowsCache="False" onhtmlrowprepared="gvMaster_HtmlRowPrepared" >
                    ...
                    <Columns>
                        <dx:GridViewDataTextColumn FieldName="廠商代號" runat="server" Caption="<%$ Resources:WebResources, SupplierNo %>">
                            <DataItemTemplate>
                                <uc1:PopupControl ID="PopupControl1" runat="server" PopupControlName="ConsignmentVendorsPopup" Text='<%# Bind("廠商代號") %>' />
                                <%--<table>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <dx:ASPxButton ID="Button10" runat="server" Text="<%$ Resources:WebResources, choose %>" SkinID="PopupButton" AutoPostBack="false" />
                                        </td>
                                    </tr>
                                </table>
                        ...
                        <dx:GridViewDataTextColumn FieldName="門市編號" runat="server" Caption="<%$ Resources:WebResources, StoreNo %>">
                            <DataItemTemplate>
                                <uc1:PopupControl ID="PopupControl1" runat="server" PopupControlName="StoresPopup" Text='<%# Bind("門市編號") %>' />
                                ...
                                <%--<table>
                                    <tr>
                                        ...
                                        <td>
                                            <dx:ASPxButton ID="Button9" runat="server" Text="<%$ Resources:WebResources, choose %>" SkinID="PopupButton" AutoPostBack="false" />
                                        </td>
                                    </tr>
                                </table>
                            ...
                            <DataItemTemplate>
                              ...
                              <%--  <table>
                                    <tr>
                                        ...
                                        <td>
                                            <dx:ASPxButton ID="Button8" runat="server" Text="<%$ Resources:WebResources, choose %>" SkinID="PopupButton" AutoPostBack="false" />
                                        </td>
                                    </tr>
                                </table>
                        ...
                        <dx:GridViewDataTextColumn FieldName="異常原因" runat="server" Caption="<%$ Resources:WebResources, ErrorDescription %>">
                        </dx:GridViewDataTextColumn>
                    </Columns>
                </dx:ASPxGridView>
            </ContentTemplate>
        ...
        <div class="btnPosition">
            <table align="center">
            <tr>
            <td><dx:ASPxButton ID="Button3" runat="server" Text="<%$ Resources:WebResources, CommitUpload %>" /></td>
