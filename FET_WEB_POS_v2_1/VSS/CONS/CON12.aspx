        ...
        <div class="criteria">
            <table>
                    ...
                    <td class="tdval" nowrap="nowrap">
                        <dx:ASPxComboBox ID="DropDownList1" runat="server" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged"
                            ...
                            <Items>
                                ...
                                <dx:ListEditItem Text="COR2010072101" Value="COR2010072101" />
                                <dx:ListEditItem Text="COR2010072102" Value="COR2010072102" />
                                <dx:ListEditItem Text="COR2010072103" Value="COR2010072103" />
                            </Items>
                        </dx:ASPxComboBox>
                    </td>
                    <td class="tdtxt" nowrap="nowrap">
                ...
                <tr>
                    ...
                    <td class="tdval" nowrap="nowrap">
                        <dx:ASPxLabel ID="Label6" runat="server" Text="2010/07/01">
                        </dx:ASPxLabel>
                    </td>
                    <td class="tdtxt" nowrap="nowrap">
                        <!--退倉訖日-->
                    ...
                    <td class="tdval" nowrap="nowrap">
                        <dx:ASPxLabel ID="Label8" runat="server" Text="2010/07/01">
                        </dx:ASPxLabel>
                    </td>
                    <td class="tdtxt" nowrap="nowrap">
                        <!--更新日期-->
                    ...
                    <td class="tdval" nowrap="nowrap">
                        <dx:ASPxLabel ID="Label3" runat="server" Text="10/08/31 15:00">
                        </dx:ASPxLabel>
                    </td>
                </tr>
                <tr>
                    ...
                    <cc:ASPxGridView ID="gvMaster" ClientInstanceName="gvMaster" runat="server" KeyFieldName="項次"
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataTextColumn runat="server" FieldName="實際退倉數量" Caption="<%$ Resources:WebResources, ActualRetunedQuantity %>">
                                ...
                                <DataItemTemplate>
                                    <dx:ASPxTextBox ID="TextBox3" Width="50px" runat="server" Text='<%# Bind("實際退倉數量") %>'>
        ...
        <div class="btnPosition">
            <table cellpadding="0" cellspacing="0" border="0" align="center">
                <tr>
                    ...
                    <td>
                        <dx:ASPxButton ID="Button4" runat="server" Text="<%$ Resources:WebResources, PrintReceipt %>" />
                    </td>
                </tr>
            </table>
        </div>
