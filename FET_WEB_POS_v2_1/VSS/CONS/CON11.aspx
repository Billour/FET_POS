<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="CON11.aspx.cs" Inherits="VSS_CONS_CON11" %>
        ...
        <div class="criteria">
            <table>
                ...
                <tr>
                    <td class="tdtxt" nowrap="nowrap">
                        <!--退倉起日-->
                        <dx:ASPxLabel ID="Literal3" runat="server" Text="<%$ Resources:WebResources, ReturnWarehousingStartDate %>"></dx:ASPxLabel>：
                    </td>
                ...
                <tr>
                    <td class="tdtxt" nowrap="nowrap">
                        <!--退倉訖日-->
                        <dx:ASPxLabel ID="Literal6" runat="server" Text="<%$ Resources:WebResources, ReturnWarehousingendDate %>"></dx:ASPxLabel>：
                    </td>
                    <td class="tdval" colspan="3" nowrap="nowrap">
                        <table cellpadding="0" cellspacing="0" border="0" style="width:240px">
                            <tr>
                ...
                <tr>
                    <td class="tdtxt" nowrap="nowrap">
                        <!--實際退倉日期-->
                        <dx:ASPxLabel ID="Literal9" runat="server" Text="<%$ Resources:WebResources, RearyReturnWarehousingDay %>"></dx:ASPxLabel>：
                    </td>
            ...
            <ContentTemplate>
                <cc:ASPxGridView ID="gvMaster" ClientInstanceName="gvMaster" runat="server" KeyFieldName="退倉單號" 
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn FieldName="退倉起日" runat="server" Caption="<%$ Resources:WebResources, ReturnWarehousingstartDate %>"></dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="退倉訖日" runat="server" Caption="<%$ Resources:WebResources, ReturnWarehousingendDate %>"></dx:GridViewDataTextColumn>
                    ...
                    <Templates>
                        <DetailRow>
                                 <cc:ASPxGridView ID="gvDetail" runat="server" ClientInstanceName="gvDetail" Settings-ShowTitlePanel="true"
                                    ...
                                    <Templates>
                                        <TitlePanel>
                                            <asp:Literal ID="Literal166" runat="server" Text="<%$ Resources:WebResources, ReturnWarehousingReceiptNo %>"></asp:Literal>：
                                            <asp:Label ID="Label5" runat="server" Text="COR2010073001" ></asp:Label>
                                        </TitlePanel>                                
                                    </Templates>
                                    <Styles>
