...
namespace RTN_NOTIFICATION
{
    class Program
    {
        ...
        static string SP_RTN_NOTIFICATION()
        {
            ...
            try
            {
                ...
                OracleCommand oraCmd = new OracleCommand("PK_CONVERT.SP_RTN_NOTIFICATION");
