...
namespace SIM_GROUP_SAFEQTY_ALERT
{
    class Program
    {
        ...
        {
            //初始化LOG
            Console.WriteLine("1.SIM_GROUP_SAFEQTY_ALERT開始");
            Console.WriteLine("2.初始化LOG");
            ConvertLog con_log = new ConvertLog("SIM_GROUP_SAFEQTY_ALERT");
