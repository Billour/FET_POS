...
namespace COUNT_RECOMMANDED
{
    class Program
    {
        static void Main(string[] args)
        {
            try
            {
                Console.WriteLine("COUNT_RECOMMANDED");
                Console.WriteLine("初始化log");
                ConvertLog cLog = new ConvertLog("COUNT_RECOMMANDED");
                try
                {
                    Console.WriteLine("SP_COUNT_RECOMMANDED");
                    string sMsg = SP_COUNT_RECOMMANDED();
        ...
        public static string SP_COUNT_RECOMMANDED()
        {
            ...
            try
            {
                ...
                OracleCommand oraCmd = new OracleCommand("SP_COUNT_RECOMMANDED");
        ...
        //static void Main(string[] args)
        //{
        //    Console.WriteLine("COUNT_RECOMMANDED 開始執行...");
        //    try {
        //        //***檢查逾時設定
        ...
        //        Console.WriteLine("初始化log");
        //        cLog = new ConvertLog("COUNT_RECOMMANDED");
