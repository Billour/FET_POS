<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DIS01_Customer_Import.aspx.cs"
    Inherits="VSS_DIS_DIS01_Customer_Import" %>
...
<body>
    ...
    <div class="func">
        ...
        <cc:ASPxGridView ID="gvProduct" ClientInstanceName="gvProduct" runat="server" KeyFieldName="CUSTMO"
            Width="100%" AutoGenerateColumns="False" 
            OnHtmlRowPrepared="gvProduct_HtmlRowPrepared" 
            onpageindexchanged="gvProduct_PageIndexChanged">
            <Columns>
                <dx:GridViewDataTextColumn FieldName="CUSTMO" runat="server" ReadOnly="true" Caption="客戶門號"
                    VisibleIndex="0">
                    <PropertiesTextEdit>
                        <ReadOnlyStyle>
