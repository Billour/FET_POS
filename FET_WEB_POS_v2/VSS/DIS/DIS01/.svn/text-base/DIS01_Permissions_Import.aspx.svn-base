<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DIS01_Permissions_Import.aspx.cs"
    Inherits="VSS_DIS_DIS01_Permissions_Import" %>
...
<body>
    ...
    <div class="func">
        ...
        <cc:ASPxGridView ID="gvProduct" ClientInstanceName="gvProduct" runat="server" KeyFieldName="PROMO"
            Width="100%" AutoGenerateColumns="False" 
            OnHtmlRowPrepared="gvProduct_HtmlRowPrepared" 
            onpageindexchanged="gvProduct_PageIndexChanged">
            <Columns>
                <dx:GridViewDataTextColumn FieldName="PROMO" runat="server" ReadOnly="true" Caption="<%$ Resources:WebResources, PromotionCode %>"
                    VisibleIndex="0">
                    <PropertiesTextEdit>
                        <ReadOnlyStyle>
                ...
                <dx:GridViewDataTextColumn FieldName="PROMONAME" runat="server" ReadOnly="True" Caption="<%$ Resources:WebResources, PromotionName %>"
                    VisibleIndex="1">
                    <PropertiesTextEdit>
                        <ReadOnlyStyle>
                            <Border BorderStyle="None" />
