...
public partial class VSS_DIS_DIS01_Import : Popup
{
   ...
   private static string USER_ID = "";
    ...
    private void bindMasterDataProduct()
    {
       DataTable dtResult = new DataTable();
    ...
    protected void btnImport_Click(object sender, EventArgs e)
    {
        try
        {
           ...
           try
           {
               _DIS01_Facade.ImportHeadQuarter(_DIS01_DiscountMasterDataSet_DTO, "PRODUCT", "");
           }
           catch (Exception ex)
           {
              throw ex;
           ...
           DataTable dtNew = _DIS01_Facade.GetImportTempData(BATCH_NO, FINC_ID, USER_ID, "PRODUCT");
