                                ...
                                <tr>
                                    <td align="right">
                                        <dx:ASPxButton ID="btnCash" runat="server" Text="<%$ Resources:WebResources, Cash %>"
                                            ...
                                            <ClientSideEvents Click="function(s, e) {
	                                                openwindowByEncrypt('../CheckOut/CheckOutCash.aspx',100,100);
                                                }" />
                                        </dx:ASPxButton>
                                    </td>
                                    <td align="left">
                                    ...
                                    <td align="left">
                                        <dx:ASPxButton ID="btnCredit" runat="server" Text="<%$ Resources:WebResources, CreditCard %>"
                                            ...
                                            <ClientSideEvents Click="function(s, e) {
                                                    openwindowByEncrypt('../CheckOut/CheckOutCredit.aspx',300,300);
                                                }" />
                                        </dx:ASPxButton>
                                    </td>
                                    <td align="left">
                                    ...
                                    <td align="left">
                                        <dx:ASPxButton ID="btnVisaDebit" runat="server" Text="<%$ Resources:WebResources, BankCard %>">
                                            <ClientSideEvents Click="function(s, e) {
	                                                openwindowByEncrypt('../CheckOut/CheckOutDebitCard.aspx',300,300);return false;
                                                }" />
                                        </dx:ASPxButton>
                                    </td>
                                    <td align="left">
                                    ...
                                    <td align="left">
                                        <dx:ASPxButton ID="btnOffLineCredit" runat="server" Text="<%$ Resources:WebResources, OffLineCreditCard %>">
                                            <ClientSideEvents Click="function(s, e) {
	                                                openwindowByEncrypt('../CheckOut/CheckOutCreditUnline.aspx',300,200);
                                                }" />
                                        </dx:ASPxButton>
                                    </td>
                                    <td align="left">
