...
public partial class VSS_RPT_RPL021 : BasePage
{
    ...
    {
        this.gvMaster.DataSource = new RPL_Facade().RPL021(this.txtOrdDateStart.Text, this.txtOrdDateEnd.Text,
                                                           this.ProdNo_S.Text, this.ProdNo_E.Text);
    ...
    protected void btnReset_Click(object sender, EventArgs e)
    {
        if (logMsg.ROLE_TYPE != System.Web.Configuration.WebConfigurationManager.AppSettings["DefaultRoleHQ"])
        {
            ...
            ProdNo_S.Enabled = false;
            ProdNo_E.Enabled = false;
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        //匯出至EXCEL
        BindMasterData();
        new Output().ExportXLS(550, "", Resources.WebResources.RPL021, dtHeader(), this.ASPxGridViewExporter1, null, null);
        Response.Redirect(Utils.CreateTamperProofDownloadXlsURL("RPL021.xls"));
    }
    ...
    private DataTable dtHeader()
    {
        ...
        NewRow["Text"] = ""
            ...
            + "|商品料號：" + this.ProdNo_S.Text + "～" + this.ProdNo_E.Text
            + "";
        NewRow["Align"] = "LEFT";
        NewRow["FontSize"] = "11";
