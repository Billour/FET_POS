...
public partial class VSS_RPT_RPL042 : BasePage
{
    ...
    {
        this.gvMaster.DataSource = new RPL_Facade().RPL042(this.txtOrdDateStart.Text, this.txtOrdDateEnd.Text,
    ...
    {
        BindMasterData();
        new Output().ExportXLS(800, "", Resources.WebResources.RPL042, dtHeader(), this.ASPxGridViewExporter1, null, null);
        Response.Redirect(Utils.CreateTamperProofDownloadXlsURL("RPL042.xls"));
    }
    ...
    private DataTable dtHeader()
    {
        ...
        NewRow["Text"] = "銷售日期：" + this.txtOrdDateStart.Text + "～" + this.txtOrdDateEnd.Text
            + "|門市代碼：" + this.ASPxTextBox2.Text + "～" + this.ASPxTextBox3.Text;
