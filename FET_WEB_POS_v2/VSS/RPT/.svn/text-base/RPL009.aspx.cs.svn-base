...
public partial class VSS_RPT_RPL009 : BasePage
{
    ...
    {
        DataTable dt = new RPL_Facade().RPL009(this.txtOrdDateStart.Text, this.txtOrdDateEnd.Text);
        totalCount = dt.Rows.Count;
        this.gvMaster.Templates.PagerBar = new CustomPagerBarTemplate(totalCount - 1);    // 減掉一筆合計資料
    ...
    {
        BindMasterData();
        new Output().ExportXLS(800, "", Resources.WebResources.RPL09, dtHeader(), this.ASPxGridViewExporter1, null, null);
        Response.Redirect(Utils.CreateTamperProofDownloadXlsURL("RPL009.xls"));
    }
