<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RPL043.aspx.cs" MasterPageFile="~/MasterPage.master"
    Inherits="VSS_RPT_RPL043" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentPlaceHolder" runat="Server">
    <div class="titlef" align="left">
        <!--POSPOS門市銷量表-3C-->
        <asp:Literal ID="Literal1" runat="server" Text="<%$ Resources:WebResources, RPL043 %>"></asp:Literal>
    </div>
    <div class="seperate">
    </div>
    <div class="criteria">
