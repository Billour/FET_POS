...
public partial class VSS_SAL_TSAL14_TSAL14_Checkout : BasePage
{
    ...
    protected void CancelSale(OracleTransaction objTX, string masterId)
    {
        ...
        //    AffectRow = new SAL041_Facade().invalidOldTransaction(objTX, masterId, transDate, cancel_no); //lblCancelNo.Text
        //    if (AffectRow < 1)
        //    {
        //        bCheckOut = false;
