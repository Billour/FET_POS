<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeFile="SAL05.aspx.cs" Inherits="VSS_SAL_SAL05" %>
                        ...
                        <td class="tdval" nowrap="nowrap">
                            <dx:ASPxComboBox ID="cbSTATUS" runat="server" ValueType="System.String" AutoResizeWithContainer="true"
                                ...
                                <Items>
                                    ...
                                    <dx:ListEditItem Text="取消" Value="3" />
                                </Items>
                            </dx:ASPxComboBox>
                        </td>
                    </tr>
                        ...
                        <cc:ASPxGridView ID="gvMaster" runat="server" EnableCallBacks="false" ClientInstanceName="gvMaster"
                            ...
                            <Columns>
                                ...
                                <dx:GridViewDataColumn FieldName="TOTAL_AMOUNT" Caption="<%$ Resources:WebResources, AmountReceivable %>"
                                    VisibleIndex="6" />
                                <dx:GridViewDataColumn FieldName="SALE_PERSON" Caption="<%$ Resources:WebResources, SalesClerk %>"
                                    VisibleIndex="7" />
                                <dx:GridViewDataTextColumn Caption="折扣" VisibleIndex="8">
                                    <DataItemTemplate>
                                        <dx:ASPxButton ID="btnDiscount" runat="server" Text="折扣">
                                        </dx:ASPxButton>
                                        <dx:ASPxPopupControl ID="ASPxPopupControl1" runat="server" ContentUrl='<%#"~/VSS/SAL/SAL05/SAL05_DiscountDetail.aspx?" + TransferURL("POSUUID_DETAIL="+ Convert.ToString(Eval("[POSUUID_DETAIL]")))%>'
