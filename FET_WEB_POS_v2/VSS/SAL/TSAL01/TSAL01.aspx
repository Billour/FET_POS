<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
	CodeFile="TSAL01.aspx.cs" Inherits="VSS_SAL_TSAL01_TSAL01" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
	...
	<script src="scripts/TSAL01_AJAX.js" type="text/javascript"></script>
	<script src="scripts/TSAL01_SaleHead.js" type="text/javascript"></script>
	<script src="scripts/TSAL01_Master.js" type="text/javascript"></script>
	<script src="scripts/TSAL01_GridRow.js" type="text/javascript"></script>
	<script src="scripts/TSAL01_Checkout.js" type="text/javascript"></script>
	<script src="scripts/TSAL01_Discount.js" type="text/javascript"></script>
	<script src="scripts/TSAL01_ETC.js" type="text/javascript"></script>
	<script src="scripts/TSAL01_HappyGo.js" type="text/javascript"></script>
	...
	<div>
		<table width="100%" border="0" cellpadding="0" cellspacing="0" class="titlef">
			<tr>
				<td align="left">
					<!--銷售作業-->
					<asp:Label ID="labTitle" runat="server" Text="銷售作業(測)"></asp:Label>
				</td>
				<td align="right">
