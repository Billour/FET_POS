<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TSAL01_checkIDNumber.aspx.cs"
    Inherits="VSS_SAL_TSAL01_checkIDNumber" %>
                                ...
                                <script type="text/javascript">
                                    function commitCheck(s, e) {
                                        if (txtUNI_NO1.GetText() == '' && txtUNI_NO2.GetText() == '')
                                            alert('必須輸入統一編號!');
                                        else if (txtUNI_NO1.GetText() != txtUNI_NO2.GetText())
