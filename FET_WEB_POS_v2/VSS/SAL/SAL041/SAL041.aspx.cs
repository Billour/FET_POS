...
public partial class VSS_SAL_SAL041 : BasePage
{
	...
	protected void btnCancelDetail_Click(object sender, EventArgs e)
	{
		if (gvMaster.FocusedRowIndex > -1)
		{
            ...
            //Response.Redirect("~/VSS/SAL/SAL041/SAL04.aspx?SRC_TYPE=SAL041&PKEY=" + s);

            //**2011/04/21 Tina：傳遞參數時，要先以加密處理。
            string encryptUrl = Utils.Param_Encrypt("SRC_TYPE=SAL041&PKEY=" + s);
