...
public partial class VSS_LOG_LOG03b : BasePage
{
    ...
    {        
        ...
        { 
            ...
            NewRow["員工姓名"] = "員工" + StringUtil.CStr(Convert.ToChar(65 + i));
            NewRow["門市編號"] = "210" + StringUtil.CStr(i);
            NewRow["門市名稱"] = "門市" + StringUtil.CStr(Convert.ToChar(65 + i));
            NewRow["區域別"] = districts[rnd.Next(0, 2)];
            NewRow["模組名稱"] = "模組" + StringUtil.CStr(Convert.ToChar(65 + i));
            NewRow["功能名稱"] = "功能" + StringUtil.CStr(Convert.ToChar(65 + i));
            NewRow["更新人員"] = "陳建國";
