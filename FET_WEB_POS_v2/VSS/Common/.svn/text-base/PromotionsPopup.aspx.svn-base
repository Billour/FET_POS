...
<body>
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server">
      ...
      <%--      <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                ...
                Width="100%" KeyFieldName="促銷代碼" OnPageIndexChanged="grid_PageIndexChanged" 
                OnSelectionChanged="grid_SelectionChanged" 
                onhtmlrowprepared="gvMaster_HtmlRowPrepared">
                    <Columns>
                        <%--<dx:GridViewDataCheckColumn VisibleIndex="0" Width="20">
                            <DataItemTemplate>
                        ...
                        <dx:GridViewDataDateColumn VisibleIndex="0" Caption=" ">
                            <DataItemTemplate>
                                <dx:ASPxRadioButton ID="radioChoose" runat="server" GroupName="radioChoose"
                    ...
                    <table border="0" id="productDetail" runat="server" style="display: none" width="100%" align="center">
                        ...
                        <tr>
                            <td>
                                <dx:ASPxButton ID="okButton" runat="server" Text="<%$ Resources:WebResources, Ok %>" 
                                    Visible="false" onclick="OkButton_Click" />
                            </td>
                            <td>&nbsp;</td>
                            <td>
