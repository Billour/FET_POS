<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProductsPopup2.aspx.cs" Inherits="VSS_Common_ProductsPopup2" %>
            ...
            <div class="btnPosition">
                <table cellpadding="0" cellspacing="0" border="0" align="center">
                    <tr>
                        ...
                        <td>&nbsp;</td>
                        <td>
                            <dx:ASPxButton ID="btnReset" runat="server" Text="<%$ Resources:WebResources, Reset %>" SkinID="ResetButton"></dx:ASPxButton>
                        </td>
                    </tr>
                </table>                                                
            </div>
