<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProductCategoryPopup.aspx.cs" Inherits="VSS_Common_ProductCategoryPopup" %>
    ...
    <div class="func">
        <div>
            <div class="criteria">
                <table>                    
                    <tr>
                        ...
                        <td class="tdval">
                            <asp:TextBox ID="CategoryNoTextBox" runat="server" Width="100"></asp:TextBox>
                        </td>
                        <td class="tdtxt">
                            <!--類別名稱-->
                        ...
                        <td class="tdval">
                            <asp:TextBox ID="CategoryNameTextBox" runat="server" Width="100"></asp:TextBox>
                        </td>                       
                    </tr>
                </table>
            </div>
            ...
            <div class="seperate"></div>                             
             <cc:ASPxGridView ID="grid" ClientInstanceName="grid" runat="server" KeyFieldName="CATE_NO" Width="100%"              
                ...
                <Columns>   
                    ...
                    <dx:GridViewDataColumn FieldName="CATE_NO" Caption="<%$ Resources:WebResources, CategoryNo %>" />
                    <dx:GridViewDataColumn FieldName="CATE_NAME" Caption="<%$ Resources:WebResources, CategoryName %>" />                                    
                </Columns>
