...
/// PriSEEDNET 的摘要描述
/// </summary>
public class PriSEEDNET : BasePage
{
    ...
    public PdfPTable getBodyTb(List<string> DataList, bool generateImg, BaseFont bfChinese)
    {
        ...
        PdfPCell Body_C51 = new PdfPCell(new Phrase("第一段條碼：" + DataList[8], new Font(bfChinese, setFontSize, Font.NORMAL)));
        ...
        PdfPCell Body_C61 = new PdfPCell(new Phrase("第二段條碼：" + DataList[9], new Font(bfChinese, setFontSize, Font.NORMAL)));
        ...
        PdfPCell Body_C71 = new PdfPCell(new Phrase("第三段條碼：" + DataList[10], new Font(bfChinese, setFontSize, Font.NORMAL)));
        ...
        PdfPCell Body_C81 = new PdfPCell(new Phrase("現金：" + DataList[11], new Font(bfChinese, setFontSize, Font.NORMAL)));
        Body_C81.HorizontalAlignment = Element.ALIGN_LEFT; //字靠左
        ...
        //PdfPCell Body_C82 = new PdfPCell(new Phrase("信用卡：" + DataList[11], new Font(bfChinese, setFontSize, Font.NORMAL)));
        //Body_C82.HorizontalAlignment = Element.ALIGN_LEFT; //字靠左
        //Body_C82.VerticalAlignment = Element.ALIGN_CENTER; //水平置中
        //Body_C82.Border = Rectangle.NO_BORDER; //去框架格線
        //BodyTb.AddCell(Body_C82); //將資料加入Table
        BodyTb.AddCell(S1); //將空白加入Table
        ...
        BodyTb.AddCell(S1); //將空白加入Table
        PdfPCell Body_C91 = new PdfPCell(new Phrase("銷售專員：" + DataList[12], new Font(bfChinese, setFontSize, Font.NORMAL)));
        Body_C91.HorizontalAlignment = Element.ALIGN_RIGHT; //字靠右
        ...
        PdfPCell Body_C101 = new PdfPCell(new Phrase("備註：查詢繳費狀況，請攜帶此單據", new Font(bfChinese, setFontSize, Font.NORMAL)));
        ...
        PdfPCell Body_C111 = new PdfPCell(new Phrase("1.Seednet客服專線：(02)449-5000", new Font(bfChinese, setFontSize, Font.NORMAL)));
        ...
        PdfPCell Body_C121 = new PdfPCell(new Phrase("2.查詢繳費狀況，請攜帶此單據", new Font(bfChinese, setFontSize, Font.NORMAL)));
