...
public class PriETC : BasePage
{
    ...
    public PdfPTable getBodyTb(List<string> DataList, bool generateImg, BaseFont bfChinese)
    {
        ...
        PdfPCell Body_C32 = new PdfPCell(new Phrase("實數金額：" + DataList[6], new Font(bfChinese, setFontSize, Font.NORMAL)));
        ...
        PdfPCell Body_C41 = new PdfPCell(new Phrase("第一段條碼：" + DataList[7], new Font(bfChinese, setFontSize, Font.NORMAL)));
        ...
        PdfPCell Body_C51 = new PdfPCell(new Phrase("第二段條碼：" + DataList[8], new Font(bfChinese, setFontSize, Font.NORMAL)));
        ...
        PdfPCell Body_C61 = new PdfPCell(new Phrase("第三段條碼：" + DataList[9], new Font(bfChinese, setFontSize, Font.NORMAL)));
        ...
        PdfPCell Body_C71 = new PdfPCell(new Phrase("現金：" + DataList[10], new Font(bfChinese, setFontSize, Font.NORMAL)));
        ...
        PdfPCell Body_C72 = new PdfPCell(new Phrase("信用卡：" + DataList[11], new Font(bfChinese, setFontSize, Font.NORMAL)));
        Body_C72.HorizontalAlignment = Element.ALIGN_LEFT; //字靠左
        Body_C72.VerticalAlignment = Element.ALIGN_CENTER; //水平置中
        Body_C72.Border = Rectangle.NO_BORDER; //去框架格線
        BodyTb.AddCell(Body_C72); //將資料加入Table

        //BodyTb.AddCell(S1); //將空白加入Table
        //BodyTb.AddCell(S1); //將空白加入Table

        BodyTb.AddCell(S1); //將空白加入Table
        PdfPCell Body_C101 = new PdfPCell(new Phrase("銷售專員：" + DataList[12], new Font(bfChinese, setFontSize, Font.NORMAL)));
        Body_C101.HorizontalAlignment = Element.ALIGN_RIGHT; //字靠右
        ...
        PdfPCell Body_C111 = new PdfPCell(new Phrase("備註：", new Font(bfChinese, setFontSize, Font.NORMAL)));
        Body_C111.HorizontalAlignment = Element.ALIGN_LEFT; //字靠左
        Body_C111.VerticalAlignment = Element.ALIGN_CENTER; //水平置中
        Body_C111.Border = Rectangle.NO_BORDER; //去框架格線
        BodyTb.AddCell(Body_C111); //將資料加入Table
        if (generateImg)
        {
            //圖片     
            ...
            PdfPCell Body_C112 = new PdfPCell(jpg, true);
            Body_C112.Border = Rectangle.NO_BORDER; //去框架格線
            Body_C112.PaddingTop = 1;
            Body_C112.PaddingLeft = 1;
            Body_C112.Rowspan = 6;
            BodyTb.AddCell(Body_C112);
        }
        else
        {
            PdfPCell Body_C112 = new PdfPCell(new Phrase("", new Font(bfChinese, setFontSize, Font.NORMAL)));
            Body_C112.Rowspan = 3;
            Body_C112.Border = Rectangle.NO_BORDER; //去框架格線
            BodyTb.AddCell(Body_C112); //將空白加入Table
        }

        PdfPCell Body_C121 = new PdfPCell(new Phrase("1.ETC客服專線：0809080080", new Font(bfChinese, setFontSize, Font.NORMAL)));
        Body_C121.HorizontalAlignment = Element.ALIGN_LEFT; //字靠左
        Body_C121.VerticalAlignment = Element.ALIGN_CENTER; //水平置中
        Body_C121.Border = Rectangle.NO_BORDER; //去框架格線
        BodyTb.AddCell(Body_C121); //將資料加入Table
             

        PdfPCell Body_C131 = new PdfPCell(new Phrase("2.查詢繳費狀況，請攜帶此單據", new Font(bfChinese, setFontSize, Font.NORMAL)));
        Body_C131.HorizontalAlignment = Element.ALIGN_LEFT; //字靠左
        Body_C131.VerticalAlignment = Element.ALIGN_CENTER; //水平置中
        Body_C131.Border = Rectangle.NO_BORDER; //去框架格線
        BodyTb.AddCell(Body_C131); //將資料加入Table
