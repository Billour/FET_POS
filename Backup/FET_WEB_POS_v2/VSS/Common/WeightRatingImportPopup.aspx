<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WeightRatingImportPopup.aspx.cs"
    Inherits="VSS_Common_WeightRatingImportPopup" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function cancelWindow() {
            ...
            if (parentWin && parentWin.calledByChild) {
                parentWin.calledByChild();    
            }
...
<body>
    ...
    <div class="btnPosition">
        <table align="center" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td>
                    <dx:ASPxButton ID="Button3" runat="server" 
                        Text="<%$ Resources:WebResources, Reset %>" onclick="Button3_Click" />
                </td>
            </tr>
        </table>
    </div>
    ...
    <cc:ASPxGridView ID="gvMaster" ClientInstanceName="gvMaster" runat="server" KeyFieldName="門市編號"
        Width="100%" OnHtmlDataCellPrepared="gvMaster_HtmlDataCellPrepared" OnHtmlFooterCellPrepared="gvMaster_HtmlFooterCellPrepared" >
        <Columns>
            ...
            <dx:GridViewDataTextColumn FieldName="比率" runat="server" Caption="<%$ Resources:WebResources, Ratio %>">
            </dx:GridViewDataTextColumn>
    ...
    <div class="btnPosition">
        <table align="center">
            <tr>
                ...
                <td>
                    <dx:ASPxButton ID="btnCancel" runat="server" Text="<%$ Resources:WebResources, Cancel %>" OnClick="btnCancel_Click">
                    <ClientSideEvents Click="function(s, e) { hidePopupWindow();}" />
                    </dx:ASPxButton>
                </td>
            </tr>
