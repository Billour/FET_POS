<%@ Page Language="C#" AutoEventWireup="true" CodeFile="INV02.aspx.cs" Inherits="VSS_INV_INV02" %>
    ...
    <script type="text/javascript" language="javascript">
        function checkID() {
            ...
            if (vID.length != 8 && vID > 0) {
                openwindowByEncrypt("SAL01_checkIDNumber.aspx", 300, 200);
                return false;
            }
        }
    </script>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td class="tdval">
                        ...
                        <asp:Button ID="Button2" runat="server" Text="<%$ Resources:WebResources, Choose %>" OnClientClick="openwindowByEncrypt('../SAL/SAL01_chooseStore.aspx', 500, 550);return false;" />
                    </td>
                    <td class="tdtxt">
                        <!--更新日期-->
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="<%$ Resources:WebResources, ProductCode %>">
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <asp:Button ID="Button9" runat="server" Text="<%$ Resources:WebResources, Choose %>" OnClientClick="openwindowByEncrypt('../SAL/SAL01_searchProductNo.aspx',300,300);return false;" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="<%$ Resources:WebResources, Imei %>">
                                    <ItemTemplate>
                                        <asp:Button ID="Button10" runat="server" Text="<%$ Resources:WebResources, Choose %>" OnClientClick="openwindowByEncrypt('../SAL/SAL01_inputIMEIData.aspx', 500, 550);return false;" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
