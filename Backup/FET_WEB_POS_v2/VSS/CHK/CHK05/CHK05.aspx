<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeFile="CHK05.aspx.cs" Inherits="VSS_CHK_CHK05" %>
    ...
    <div class="criteria">
        <table>
            <tr>
                ...
                <td>
                    <dx:ASPxDateEdit ID="txtTraneDateS" runat="server" ClientInstanceName="txtSDate">
                    </dx:ASPxDateEdit>
                </td>
                <td class="tdtxt">
                    <!--機台編號-->
        ...
        <ContentTemplate>   
            <cc:ASPxGridView ID="grid" ClientInstanceName="grid" runat="server" 
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn FieldName="AMOUNT" Caption="繳大鈔">
                        <EditItemTemplate>
