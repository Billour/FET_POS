...
public partial class VSS_PRE_PRE01 : BasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            //btnCash.ClientSideEvents.Click = "openwindowByEncrypt('../CheckOut/CheckOutCash.aspx',100,100);";
        }
    }
    ...
    private DataTable getMasterData()
    {
        ...
        dtResult.Columns.Add("預購金額", typeof(int));
        dtResult.Columns.Add("數量", typeof(int));
        dtResult.Columns.Add("預收款說明", typeof(string));
        dtResult.Columns.Add("總價", typeof(int));
