...
public partial class VSS_RPT_RPL010 : BasePage
{
    ...
    {
        this.gvMaster.DataSource = new RPL_Facade().RPL010(this.ASPxTextBox2.Text, this.ASPxTextBox3.Text,      // 門市編號
                                                           this.ASPxRadioButtonList1.SelectedItem.Text,         // 轉入總帳
    ...
    {
        BindMasterData();
        new Output().ExportXLS(920, "", Resources.WebResources.RPL010, dtHeader(), this.ASPxGridViewExporter1, null, null);
        Response.Redirect(Utils.CreateTamperProofDownloadXlsURL("RPL010.xls"));
    }
    ...
    private DataTable dtHeader()
    {
        ...
        NewRow["Text"] = ""
            ...
            + "|轉入總帳：" + this.ASPxRadioButtonList1.SelectedItem.Text
    ...
    protected void btnReset_Click(object sender, EventArgs e)
    {
        ...
        this.ASPxRadioButtonList1.SelectedIndex = 0;
