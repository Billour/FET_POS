...
public partial class VSS_RPT_RPL043 : BasePage
{
    ...
    {
        this.gvMaster.DataSource = new RPL_Facade().RPL043(this.txtOrdDateStart.Text, this.txtOrdDateEnd.Text,
    ...
    {
        BindMasterData();
        new Output().ExportXLS(800, "", Resources.WebResources.RPL043, dtHeader(), this.ASPxGridViewExporter1, null, null);
        Response.Redirect(Utils.CreateTamperProofDownloadXlsURL("RPL043.xls"));
    }
