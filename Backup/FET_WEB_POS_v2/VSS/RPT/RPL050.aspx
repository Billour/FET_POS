<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RPL050.aspx.cs" MasterPageFile="~/MasterPage.master"
    Inherits="VSS_RPT_RPL050" %>
        ...
        function CheckDate(s, e) {
            ...
            if (txtOrdDateStart.GetText() != '' && txtOrdDateEnd.GetText() != '') {
                if (txtOrdDateStart.GetValue() > txtOrdDateEnd.GetValue()) {
                    alert("[銷退日期起值]不允許大於[銷退日期訖值]，請重新輸入!");
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentPlaceHolder" runat="Server">
    <div class="titlef" align="left">
        <!--門市折讓明細表-->
        <asp:Literal ID="Literal1" runat="server" Text="<%$ Resources:WebResources, RPL050 %>"></asp:Literal>
    </div>
    <div class="seperate">
    </div>
    <div class="criteria">
    ...
    <cc:ASPxGridView ID="gvMaster" ClientInstanceName="gvMaster" runat="server" KeyFieldName="RTNNO"
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn FieldName="開立日期" Caption="開立日期" />
            <dx:GridViewDataTextColumn FieldName="原買受人" Caption="原買受人" />
            <dx:GridViewDataTextColumn FieldName="統一編號" Caption="統一編號" />
            ...
            <dx:GridViewDataColumn FieldName="金額(不含稅)" Caption="金額(不含稅)" />
