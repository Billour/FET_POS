...
public partial class VSS_RPT_RPL034 : BasePage
{
    ...
    {
        DataTable dt = new RPL_Facade().RPL034(this.txtTRADE_DATE_S.Text, this.txtTRADE_DATE_E.Text,
            this.pupPRODTYPENO_S.Text, this.pupPRODTYPENO_E.Text, 
            this.txtPRODNO_S.Text, this.txtPRODNO_E.Text);
    ...
    private DataTable dtHeader()
    {
        ...
        NewRow["Text"] = "交易日期：" + this.txtTRADE_DATE_S.Text + "～" + this.txtTRADE_DATE_E.Text
                      + "|商品類別：" + this.pupPRODTYPENO_S.Text + "～" + this.pupPRODTYPENO_E.Text
    ...
    {
        BindMasterData();
        new Output().ExportXLS(650, "", Resources.WebResources.RPL034, dtHeader(), this.ASPxGridViewExporter1, null, null);
        Response.Redirect(Utils.CreateTamperProofDownloadXlsURL("RPL034.xls")); 
    }
    ...
    protected void btnReset_Click(object sender, EventArgs e)
    {
        ...
        this.pupPRODTYPENO_S.Text = null;
        this.pupPRODTYPENO_E.Text = null;
