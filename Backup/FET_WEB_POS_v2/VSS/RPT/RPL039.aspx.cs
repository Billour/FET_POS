...
public partial class VSS_RPT_RPL039 : BasePage
{
    ...
    */
    ...
    {
        this.gvMaster.DataSource = new RPL_Facade().RPL039(this.txtOrdDateStart.Text, this.txtOrdDateEnd.Text);
    ...
    */
    protected void btnExport_Click(object sender, EventArgs e)
    {
        //匯出至EXCEL
        BindMasterData();
        new Output().ExportXLS(1300, "", Resources.WebResources.RPL039, dtHeader(), this.ASPxGridViewExporter1, null, null);
        Response.Redirect(Utils.CreateTamperProofDownloadXlsURL("RPL039.xls"));
    }
    ...
    */
    private DataTable dtHeader()
    {
        ...
        NewRow["Text"] = ""
            + "生效日期：" + this.txtOrdDateStart.Text + "～" + this.txtOrdDateEnd.Text
            + "|執行日期：" + DateTime.Now.ToString("yyyy/MM/dd")
            + "";
        NewRow["Align"] = "LEFT";
        NewRow["FontSize"] = "11";
