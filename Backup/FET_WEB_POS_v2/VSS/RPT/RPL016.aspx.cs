...
public partial class VSS_RPT_RPL016 : BasePage
{
    ...
    {
        this.gvMaster.DataSource = new RPL_Facade().RPL016(this.txtOrdDateStart.Text, this.txtOrdDateEnd.Text, //交易日期
                                                           this.ASPxTextBox1.Text, this.ASPxTextBox2.Text, //門市編號
                                                          StringUtil.CStr( this.ASPxComboBox3.SelectedItem.Value ), //憑證類型
                                                           this.ASPxDateEdit1.Text, this.ASPxDateEdit2.Text); //訂單日期
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        //匯出至EXCEL
        BindMasterData();
        new Output().ExportXLS(1253, "", Resources.WebResources.RPL016, dtHeader(), this.ASPxGridViewExporter1, null, null);
        Response.Redirect(Utils.CreateTamperProofDownloadXlsURL("RPL016.xls"));
    }
    ...
    private DataTable dtHeader()
    {
        ...
        NewRow["Text"] = ""
            ...
            + "|憑證類型：" + this.ASPxComboBox3.SelectedItem.Text
            + "|門市編號：" + this.ASPxTextBox1.Text + "～" + this.ASPxTextBox2.Text
            + "|訂單日期：" + this.ASPxDateEdit1.Text + "～" + this.ASPxDateEdit2.Text
            + "";
        NewRow["Align"] = "LEFT";
        NewRow["FontSize"] = "11";
