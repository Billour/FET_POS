<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CON10_chooseSupplierNo.aspx.cs" Inherits="VSS_CONS_CON10_chooseSupplierNo" %>
...
<body>
    ...
    <div>
        ...
        <div class="btnPosition">
            <table>
                <tr>
                    <td><dx:ASPxButton ID="Button1" runat="server" Text="<%$ Resources:WebResources, Ok %>" >
                            <ClientSideEvents Click="function(s,e){window.close();return false;}"></ClientSideEvents>
                        </dx:ASPxButton>
                    </td>
