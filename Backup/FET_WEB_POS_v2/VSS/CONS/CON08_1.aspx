<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CON08_1.aspx.cs" Inherits="VSS_CONS_CON08_1" %>
            ...
            <EmptyDataTemplate>
                ...
                <tr>
                    <td colspan="8" class="tdEmptyData">
                         <asp:Literal ID="Literal6" runat="server" Text="<%$ Resources:WebResources, NoRecordsImported %>"></asp:Literal>
                    </td>
                </tr>
            </EmptyDataTemplate>
            <Columns>
                ...
                <asp:BoundField DataField="異常原因" HeaderText="<%$ Resources:WebResources, ErrorDescription %>" />
            </Columns>
        </asp:GridView>
        <div class="seperate">
        </div>
