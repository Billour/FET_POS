<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="CON05.aspx.cs" Inherits="VSS_CONS_CON05" %>
            ...
            <table>
                <tr>
                    ...
                    <td class="tdval" nowrap="nowrap">
                        <dx:ASPxDateEdit ID="dxOrderDate" runat="server">
                        </dx:ASPxDateEdit>
                    </td>
                    <td class="tdtxt" nowrap="nowrap">
                        <!--訂單編號-->
                ...
                <tr>
                    ...
                    <td class="tdval" nowrap="nowrap">
                       <uc1:PopupControl ID="ProductsPopup1" runat="server" PopupControlName="ProductsPopup"  />
                       <%-- <table>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <dx:ASPxButton ID="Button5" runat="server" Text="<%$ Resources:WebResources, Choose %>"
                    ...
                    <td class="tdval" colspan="2" nowrap="nowrap">
                        <dx:ASPxLabel ID="Literal24" runat="server" Text="21031 門市名稱1">
                        </dx:ASPxLabel>
                    </td>
                </tr>
            </table>
...
<%--        <cc:ASPxPopupControl ID="productsPopup" SkinID="ProductsPopup" runat="server" EnableViewState="False"
            PopupElementID="Button5" TargetElementID="TextBox1" LoadingPanelID="lp1">
        </cc:ASPxPopupControl>
                    ...
                    <Templates>
                        <DetailRow>
                            <cc:ASPxGridView ID="gvDetail" runat="server" ClientInstanceName="gvDetail" Settings-ShowTitlePanel="true"
                                ...
                                <Templates>
                                    <TitlePanel>
                                        <asp:Literal ID="Literal1" runat="server" Text="<%$ Resources:WebResources, OrderNo %>"></asp:Literal>：
