<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CON07.aspx.cs" Inherits="VSS_CONS_CON07" %>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td class="tdval" nowrap="nowrap">
                        ...
                        <asp:Button ID="btnChooseProduct" runat="server" Text="<%$ Resources:WebResources, Choose %>" OnClientClick="openwindowByEncrypt('../ORD/ORD01_searchProductNo.aspx',500,400);" />
                    </td>
                     <!--門市編號-->
                    <td class="tdtxt" nowrap="nowrap">
                    ...
                    <td class="tdval" nowrap="nowrap">
                        ...
                        <asp:Button ID="Button2" runat="server" Text="選" OnClientClick="openwindowByEncrypt('../INV/INV18_3.aspx',640,300);return false;" />
                    </td>
                </tr>
