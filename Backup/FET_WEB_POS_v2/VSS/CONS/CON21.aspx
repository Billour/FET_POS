<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="CON21.aspx.cs" Inherits="VSS_CONS_CON21" %>
        ...
        <cc:ASPxGridView ID="gvMaster" ClientInstanceName="gvMaster" 
            ...
            ondetailrowexpandedchanged="gvMaster_DetailRowExpandedChanged">
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn FieldName="移出時間" runat="server" Caption="<%$ Resources:WebResources,OutOfTime%>"></dx:GridViewDataTextColumn>
                    ...
                    <dx:GridViewDataTextColumn FieldName="撥入時間" runat="server" Caption="<%$ Resources:WebResources,IntoTime%>"></dx:GridViewDataTextColumn>
