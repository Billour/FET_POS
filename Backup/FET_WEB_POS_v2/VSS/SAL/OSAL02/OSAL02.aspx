<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeFile="OSAL02.aspx.cs" Inherits="VSS_SAL_OSAL02" %>
        ...
        <div class="titlef">
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    <td align="left">
                        <!--舊POS作廢查詢-->
                        <asp:Literal ID="Literal1" runat="server" Text="<%$ Resources:WebResources, OldPosCancelSearch %>" />
                    </td>
                    <td align="right">
                    ...
                    <td class="tdval">
                        <dx:ASPxComboBox ID="cbPAY_METHOD" runat="server" ValueType="System.String" AutoResizeWithContainer="true"
                            ...
                            <Items>
                                ...
                                <dx:ListEditItem Text="Happy GO" Value="3" />
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <div class="SubEditBlock">
                    <cc:ASPxGridView ID="gvMaster" runat="server" ClientInstanceName="gvMaster" KeyFieldName="ITEMS"
