<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeFile="OSAL042.aspx.cs" Inherits="VSS_SAL_OSAL042" %>
    ...
    <div>       
                                ...
                                <td>
                                    <dx:ASPxDateEdit ID="txtS_Date" runat="server">
                                        <ValidationSettings CausesValidation="false" >
                                            <RequiredField IsRequired="true" ErrorText="交易日期未輸入，請重新輸入" />
                                        </ValidationSettings>
                                    </dx:ASPxDateEdit>
                                </td>
                                <td>
        ...
        <div class="btnPosition" id="showFooter" runat="server" visible="true">
            <table cellpadding="0" cellspacing="0" border="0" align="center">
                <tr>
                    <td>
                        <dx:ASPxButton ID="btnExportExcel" runat="server" Text="匯出Excel" AutoPostBack="true" OnClick="btnExportExcel_Click">
                        </dx:ASPxButton>
                    </td>
                </tr>
            </table>
