...
public partial class VSS_SAL_TSAL031 : BasePage
{
	...
	protected void btnChangeProd_Click(object sender, EventArgs e)
	{
		if (gvMaster.FocusedRowIndex > -1)
		{
            ...
            //Response.Redirect("~/VSS/SAL/TSAL01/TSAL01.aspx?SRC_TYPE=TSAL031&PKEY=" + s);

            //**2011/04/21 Tina：傳遞參數時，要先以加密處理。
            string encryptUrl = Utils.Param_Encrypt("SRC_TYPE=TSAL031&PKEY=" + s);
