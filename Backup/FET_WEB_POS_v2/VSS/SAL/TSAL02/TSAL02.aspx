<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeFile="TSAL02.aspx.cs" Inherits="VSS_SAL_TSA02" %>
    ...
    <div>       
        <div class="titlef">
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td align="right">
                        <dx:ASPxButton ID="btnQuery" runat="server" Text="<%$ Resources:WebResources, Selling %>" AutoPostBack="false">
                            <ClientSideEvents Click="function(s,e){document.location='../SAL01/SAL01.aspx';return false;}" />
                        </dx:ASPxButton>
                    </td>
                </tr>
            </table>
        ...
        <div class="btnPosition" id="showFooter" runat="server" visible="true">
            <table cellpadding="0" cellspacing="0" border="0" align="center">
                <tr>
                    <td>
                        <dx:ASPxButton ID="Button1" runat="server" Text="<%$ Resources:WebResources, View %>" onclick="Button1_Click">
                        </dx:ASPxButton>
                    </td>
                    <td>
                        &nbsp;
                    ...
                    <td>
                        <dx:ASPxButton ID="btnCancelDetail" runat="server" Text="作廢明細查詢" AutoPostBack="true" OnClick="btnCancelDetail_Click">
                        </dx:ASPxButton>
                    </td>
                </tr>
            </table>
