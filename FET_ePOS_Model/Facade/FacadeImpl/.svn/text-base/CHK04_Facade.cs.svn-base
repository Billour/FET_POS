...
namespace FET.POS.Model.Facade.FacadeImpl
{
    public class CHK04_Facade
    {
        ...
        public DataTable Query_SmallChange(string txtTraneDateS, string txtTraneDateE,
            string MACHINE_ID, string STORE_NO)
        {
            ...
            sb.Append("FROM SMALL_CHANGE B, STORE_TERMINATING_MACHINE M, EMPLOYEE E ");
            sb.Append("WHERE 1 =1 ");
        ...
        /// 新增找零金
        /// </summary>
        /// <param name="ds">CHK04 DataSet</param>
        public void AddNewOne_SmallChange(CHK04_SmallChange_DTO ds)
        {
            OracleDBUtil.Insert(ds.Tables["SMALL_CHANGE"]);
        }
        ...
        /// </summary>
        /// <param name="ds">CHK04 DataSet</param>
        public void Delete_SmallChange(CHK04_SmallChange_DTO ds)
        {
            ...
            try
            {
                ...
                OracleDBUtil.DELETEByUUID(objTX, ds.Tables["SMALL_CHANGE"], "ID");
