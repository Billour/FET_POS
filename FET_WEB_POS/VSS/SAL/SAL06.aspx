<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SAL06.aspx.cs" Inherits="VSS_SAL_SAL06" %>
                    ...
                    <tr>
                        ...
                        <td class="tdval" nowrap="nowrap">
                            <asp:DropDownList ID="DropDownList1" runat="server" CssClass="ddlWidthFormat">
                                ...
                                <asp:ListItem Selected="True">待審核</asp:ListItem>
                    ...
                    <tr>
                        ...
                        <td class="tdval" nowrap="nowrap">
                            <asp:DropDownList ID="DropDownList2" runat="server" CssClass="ddlWidthFormat">
                                ...
                                <asp:ListItem Text="王大明"></asp:ListItem>
                                <asp:ListItem Text="陳明真"></asp:ListItem>
                            </asp:DropDownList>
                        </td>
                    </tr>
                </table>
                        ...
                        <asp:GridView ID="gvMaster" runat="server" AutoGenerateColumns="False" CssClass="mGrid" AllowPaging="True"
                            ...
                            <EmptyDataTemplate>
                                <tr>
                                    ...
                                    <th scope="col" nowrap="nowrap">
                                        <!--申請日期-->
                                         <asp:Literal ID="Literal10" runat="server" Text="<%$ Resources:WebResources, ApplicationDate %>"></asp:Literal>
                                    </th>
                                    <th scope="col" nowrap="nowrap">
                                        <!--服務屬性-->
                                         <asp:Literal ID="Literal11" runat="server" Text="<%$ Resources:WebResources, ServiceNature %>"></asp:Literal>
                                    </th>
                                    <th scope="col" nowrap="nowrap">
                                        <!--服務類別-->
                                         <asp:Literal ID="Literal12" runat="server" Text="<%$ Resources:WebResources, ServiceClass %>"></asp:Literal>
                                    </th>
                                    <th scope="col" nowrap="nowrap">
                                        <!--應收總金額-->
                                         <asp:Literal ID="Literal13" runat="server" Text="<%$ Resources:WebResources, AmountReceivable %>"></asp:Literal>
                                    </th>
                                    <th scope="col" nowrap="nowrap">
                                        <!--客戶門號-->
                                         <asp:Literal ID="Literal14" runat="server" Text="<%$ Resources:WebResources, CustomerMobileNumber %>"></asp:Literal>
                                    </th>
                                    <th scope="col" nowrap="nowrap">
                                        <!--銷售人員-->
                                         <asp:Literal ID="Literal15" runat="server" Text="<%$ Resources:WebResources, SalesClerk %>"></asp:Literal>
                                    </th>
                                </tr>
                                <tr>
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="門號" HeaderText="<%$ Resources:WebResources, CustomerMobileNumber %>" ItemStyle-Wrap="false" HeaderStyle-Wrap="false"/>
                        ...
                        <asp:GridView ID="gvDetail" runat="server" AutoGenerateColumns="False" CssClass="mGrid"
                            ...
                            <EmptyDataTemplate>
                                <tr>
                                    <th scope="col" nowrap="nowrap">
                                        <!--項次-->
                                        <asp:Literal ID="Literal15" runat="server" Text="<%$ Resources:WebResources, Items %>"></asp:Literal>
                                    </th>
                                    <th scope="col" nowrap="nowrap">
                                        <!--促銷代號-->
                                        <asp:Literal ID="Literal17" runat="server" Text="<%$ Resources:WebResources, PromotionCode %>"></asp:Literal>
                                    </th>
                                    <th scope="col" nowrap="nowrap">
                                        <!--促銷名稱-->
                                        <asp:Literal ID="Literal18" runat="server" Text="<%$ Resources:WebResources, PromotionName %>"></asp:Literal>
                                    </th>
                                    <th scope="col" nowrap="nowrap">
                                        <!--商品料號-->
                                    ...
                                    <th scope="col" nowrap="nowrap">
                                        <!--卡片序號(SIM)-->
                                        <asp:Literal ID="Literal21" runat="server" Text="<%$ Resources:WebResources, SimCardSerialNumber %>"></asp:Literal>
                                    </th>
                                    <th scope="col" nowrap="nowrap">
                                        <!--金額-->
                                        <asp:Literal ID="Literal22" runat="server" Text="<%$ Resources:WebResources, Amount %>"></asp:Literal>
                                    </th>
                                </tr>
                                <tr>
                                    <td colspan="6" class="tdEmptyData">
                                        <!--此無明細資料-->
                                        <asp:Literal ID="Literal23" runat="server" Text="<%$ Resources:WebResources, NoResultsToDisplay %>"></asp:Literal>
                                    </td>
                                </tr>
                            </EmptyDataTemplate>
                            <Columns>
                                <asp:BoundField DataField="項次" HeaderText="<%$ Resources:WebResources, Items %>" ItemStyle-Wrap="false" HeaderStyle-Wrap="false"/>
                                <asp:BoundField DataField="促銷編號" HeaderText="<%$ Resources:WebResources, PromotionCode %>" ItemStyle-Wrap="false" HeaderStyle-Wrap="false"/>
