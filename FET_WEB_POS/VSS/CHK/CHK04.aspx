<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CHK04.aspx.cs" Inherits="VSS_CHK04_CHK04" %>
                    ...
                    <cc1:ExGridView ID="gvMaster" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <EmptyDataTemplate>
                            <tr>
                                ...
                                <th scope="col">
                                    <!--找零金-->
                                    <asp:Literal ID="Literal8" runat="server" Text="<%$ Resources:WebResources, ChangeAmount %>"></asp:Literal>
                                </th>
                                <th scope="col">
                                    <!--更新人員-->
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="交易日期" HeaderText="<%$ Resources:WebResources, TradeDate %>" ReadOnly="true" />                            
                            ...
                            <asp:TemplateField  HeaderText="<%$ Resources:WebResources, ChangeAmount %>">
                                <EditItemTemplate>
                                    <asp:TextBox ID="txtAmount" runat="server" Text='<%# Bind("找零金") %>' Width="80"></asp:TextBox>
                                </EditItemTemplate>
                                <ItemTemplate>
                                    <asp:Label ID="lblAmount" runat="server" Text='<%# Eval("找零金") %>'></asp:Label>
                                </ItemTemplate>                        
                                <FooterTemplate>
