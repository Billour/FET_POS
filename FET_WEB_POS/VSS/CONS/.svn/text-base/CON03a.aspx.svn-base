<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CON03a.aspx.cs" Inherits="VSS_CON03a_CON03a" %>
        ...
        <div class="criteria">
            <table>
                <tr>
                    ...
                    <td class="tdtxt">
                        <!--廠商名稱-->
                        <asp:Literal ID="Literal24" runat="server" Text="<%$ Resources:WebResources, SupplierName %>"></asp:Literal>：
                    </td>
                    <td class="tdval">
