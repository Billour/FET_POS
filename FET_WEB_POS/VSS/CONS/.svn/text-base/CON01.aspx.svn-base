<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CON01.aspx.cs" Inherits="VSS_CON01_CON01" %>
            ...
            <ContentTemplate>
                <div id="Div1" runat="server" class="SubEditBlock">
                    ...
                    <asp:GridView ID="gvMaster" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        CssClass="mGrid" PageSize="14" PagerStyle-HorizontalAlign="Right" OnPageIndexChanging="GridView_PageIndexChanging">
                        <EmptyDataTemplate>
                            <tr>
                                <th scope="col">
                                    <!--廠商編號-->
                                ...
                                <th scope="col">
                                    <!--合作模式-->
                                    <asp:Literal ID="Literal10" runat="server" Text="<%$ Resources:WebResources, ModalityForCooperation %>"></asp:Literal>
                                </th>
                                <th scope="col">
                                    <!--合作起訖日-->
                                ...
                                <th scope="col">
                                    <!--負責人-->
                                    <asp:Literal ID="Literal11" runat="server" Text="<%$ Resources:WebResources, Owner %>"></asp:Literal>
                                </th>
                                <th scope="col">
                                    <!--電話號碼-->
                                    <asp:Literal ID="Literal12" runat="server" Text="<%$ Resources:WebResources, Telephone %>"></asp:Literal>
                                </th>
                                <th scope="col">
                                    <!--人員-->
                                    <asp:Literal ID="Literal13" runat="server" Text="<%$ Resources:WebResources, Staff %>"></asp:Literal>
                                </th>
                                <th scope="col">
                                    <!--日期-->
                                    <asp:Literal ID="Literal14" runat="server" Text="<%$ Resources:WebResources, Date %>"></asp:Literal>
                                </th>
                            </tr>
                            <tr>
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="<%$ Resources:WebResources, SupplierNo %>">
                                <EditItemTemplate>
                                    <asp:TextBox ID="Label211" runat="server" Text='<%# Bind("廠商編號") %>'></asp:TextBox>
                                </EditItemTemplate>
                                <ItemTemplate>
                                    <asp:HyperLink ID="HyperLink1" runat="server" Text='<%# Bind("廠商編號") %>' NavigateUrl='<%# Eval("廠商編號", "~/VSS/CONS/CON02.aspx?No={0}") %>'></asp:HyperLink>
                                </ItemTemplate>
                            </asp:TemplateField>
