<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DIS11.aspx.cs" Inherits="VSS_DIS11_DIS11" %>
        ...
        <div class="titlef">
            <table width="100%">
                <tr>
                    <td align="left">
                        <!--屬性主檔查詢-->
                         <asp:Literal ID="Literal1" runat="server" Text="<%$ Resources:WebResources, ProductAttributeSearch %>"></asp:Literal> 
                    </td>
                    <td align="right">
                        ...
                        <asp:GridView ID="gvMaster" runat="server" AutoGenerateColumns="False" CssClass="mGrid">
                            <EmptyDataTemplate>
                                <tr>
                                    ...
                                    <th scope="col">
                                        <!--維護人員-->
                                        <asp:Literal ID="Literal6" runat="server" Text="<%$ Resources:WebResources, MaintainedBy %>"></asp:Literal>
                                    </th>
                                </tr>
                                <tr>
