<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DIS02.aspx.cs" Inherits="VSS_DIS02_DIS02" %>
        ...
        <div class="criteria">
            <table>
                ...
                <tr>
                    <td class="tdtxt">
                        <!--有效期間-->
                        <asp:Literal ID="Literal8" runat="server" Text="<%$ Resources:WebResources, EffectiveDuration %>"></asp:Literal>：
                    </td>
                    <td class="tdval" colspan="3">
                        <asp:Literal ID="Literal9" runat="server" Text="<%$ Resources:WebResources, Start %>"></asp:Literal><cc1:postbackDate_TextBox ID="postbackDate_TextBox1" runat="server" 
                            ...
                            &nbsp;<asp:Literal ID="Literal10" runat="server" Text="<%$ Resources:WebResources, End %>"></asp:Literal><cc1:postbackDate_TextBox ID="postbackDate_TextBox2" runat="server" 
                            ImageUrl="~/Icon/calendar.jpg" />
                    </td>
                    <td class="tdtxt">
                        <!--維護人員-->
                        ...
                        <asp:GridView ID="gvMaster" runat="server" AutoGenerateColumns="False" CssClass="mGrid"
                            ...
                            <EmptyDataTemplate>
                                <tr>
                                    ...
                                    <th scope="col">
                                        <!--折扣料號-->
                                        <asp:Literal ID="Literal15" runat="server" Text="<%$ Resources:WebResources, PartNumberOfDiscount %>"></asp:Literal>
                                    </th>
                                    <th scope="col">
                                        <!--折扣名稱-->
                                        <asp:Literal ID="Literal16" runat="server" Text="<%$ Resources:WebResources, DiscountName %>"></asp:Literal>
                                    </th>
                                    <th scope="col">
                                        <!--有效日期(起)-->
                                        <asp:Literal ID="Literal17" runat="server" Text="<%$ Resources:WebResources, ValidStartDate %>"></asp:Literal>
                                    </th>
                                    <th scope="col">
                                        <!--有效日期(迄)-->
                                        <asp:Literal ID="Literal18" runat="server" Text="<%$ Resources:WebResources, ValidEndDate %>"></asp:Literal>
                                    </th>
                                    <th scope="col">
                                        <!--折扣金額-->
                                        <asp:Literal ID="Literal13" runat="server" Text="<%$ Resources:WebResources, DiscountAmount %>"></asp:Literal>
                                    </th>
                                    <th scope="col">
                                        <!--人員-->
                                    ...
                                    <th scope="col">
                                        <!--日期-->
                                        <asp:Literal ID="Literal11" runat="server" Text="<%$ Resources:WebResources, Date %>"></asp:Literal>
                                    </th>
                                </tr>
                                <tr>
