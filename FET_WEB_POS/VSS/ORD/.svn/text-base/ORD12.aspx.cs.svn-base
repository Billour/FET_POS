...
public partial class VSS_ORD_ORD12 : System.Web.UI.Page
{
   protected void Page_Load(object sender, EventArgs e)
   {
      ...
      if (!IsPostBack)
      {
         ...
         {
            this.showEditCommand.Visible = (false);
   ...
   protected void btnNew_Click(object sender, EventArgs e)
   {
      ...
      gvDetail.ShowHeader = true;
      //gvDetail.ShowFooter = true;
      System.Web.UI.HtmlControls.HtmlTableRow tr =
          gvMaster.FindChildControl<System.Web.UI.HtmlControls.HtmlTableRow>("trEmptyData");
      //System.Web.UI.HtmlControls.HtmlTableRow td =
      //    gvDetail.FindChildControl<System.Web.UI.HtmlControls.HtmlTableRow>("tdgvDetail");

      if (tr != null)
      {
         // 隱藏顯示文字訊息的表格列
         tr.Visible = false;
         showDetailGv.Visible = true;
         //td.Visible = false;
      }
      else
      {
