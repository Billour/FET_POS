<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CheckOutCreditStage.aspx.cs" Inherits="VSS_CheckOut_CheckOutCreditStage" %>
        ...
        <asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0">
            ...
            <asp:View ID="View2" runat="server">
               <div class="seperate"></div>
                ...
                <div class="btnPosition">
                    ...
                    <asp:Button ID="btnCommit5" runat="server" OnClientClick="window.close();return false;" 
                        Text="取消" Visible="false"/>
                </div>
            </asp:View>
            <asp:View ID="View3" runat="server">
                ...
                <div class="btnPosition">
                    ...
                    <asp:Button ID="btnCommit6" runat="server"  OnClientClick="window.close();return false;" 
                        Text="取消" Visible="false"/>
                </div>
            </asp:View>
        </asp:MultiView>
