<%@ Page Language="C#" AutoEventWireup="true" CodeFile="INV05.aspx.cs" Inherits="VSS_INV05_INV05" %>
        ...
        <div>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="titlef">
                <tr>
                    ...
                    <td align="right">
                        <asp:Button ID="Button3" runat="server" Text="<%$ Resources:WebResources, QueryEdit %>" OnClientClick="document.location='INV04.aspx';return false;" />
                    </td>
                </tr>
            </table>
        </div>
            ...
            <table>
                <tr>
                    ...
                    <td class="tdval" nowrap="nowrap">
                        <asp:Label ID="lbOrderNo" runat="server" Text="HR100914001"></asp:Label>
                    ...
                    <td class="tdval" nowrap="nowrap">
                        <cc1:postbackDate_TextBox ID="tbDate" runat="server" ImageUrl="~/Icon/calendar.jpg" />
                    </td>
                    <td class="tdtxt" nowrap="nowrap">
                        <!--狀態-->
                ...
                <tr>
                    ...
                    <td class="tdval" nowrap="nowrap">
                         <asp:DropDownList ID="DropDownList1" runat="server">
                            ...
                            <asp:ListItem>退倉原因代號1</asp:ListItem>
                            <asp:ListItem>退倉原因代號2</asp:ListItem>
                        </asp:DropDownList>
                    </td>
                    <td class="tdtxt" nowrap="nowrap">
                        <!--後續處理代號-->
                    ...
                    <td class="tdval" nowrap="nowrap">
                         <asp:DropDownList ID="DropDownList2" runat="server">
                            <asp:ListItem>-請選擇-</asp:ListItem>
                            <asp:ListItem>後續處理代號1</asp:ListItem>
                            <asp:ListItem>後續處理代號2</asp:ListItem>
                        </asp:DropDownList>
                    </td>
                    <td class="tdtxt" nowrap="nowrap">
                        <!--更新人員-->
                                    ...
                                    <cc1:ExGridView ID="gvMaster" runat="server" AutoGenerateColumns="False" CssClass="mGrid"
                                        ...
                                        <Columns>
                                            <asp:TemplateField FooterStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                                <HeaderTemplate>
                                                    <asp:CheckBox ID="CheckBox1" runat="server" onclick="javascript:if(this.checked){$('#Div1').checkCheckboxes();}else{$('#Div1').unCheckCheckboxes();}" />
                                                </HeaderTemplate>
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="<%$ Resources:WebResources, ProductCode %>">
                                                ...
                                                <FooterTemplate>
                                                    <asp:TextBox ID="TextBox22" runat="server" Text='<%# Bind("商品料號") %>'></asp:TextBox>
                                                    <asp:Button ID="Button12" runat="server" Text="<%$ Resources:WebResources, Choose %>" OnClientClick="openwindow('../ORD/ORD01_searchProductNo.aspx',500,400);return false;" />
                                                </FooterTemplate>
                                            </asp:TemplateField>
