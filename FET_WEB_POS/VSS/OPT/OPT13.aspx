<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OPT13.aspx.cs" Inherits="VSS_OPT_OPT13" %>
        ...
        <div class="criteria">
            <table>
                ...
                <tr>
                    ...
                    <td class="tdval" colspan="3" nowrap="nowrap">
                        <asp:Literal ID="Literal10" runat="server" Text="<%$ Resources:WebResources, Start %>"></asp:Literal><asp:TextBox ID="txtProductCode1" runat="server"></asp:TextBox><asp:Button ID="btnChooseProduct1" runat="server" Text="<%$ Resources:WebResources, Choose %>" />
                        <uc1:PopupWindow ID="PopupWindow1" runat="server"
                                    Name="SelectPromoCode" 
                                    PopupButtonID="btnChooseProduct1" 
                                    TargetControlID="txtProductCode1"
                                    Width="550" Height="400"                       
                                    NavigateUrl="~/VSS/SAL/SAL01_searchProductNo.aspx" />
                        &nbsp;<asp:Literal ID="Literal27" runat="server" Text="<%$ Resources:WebResources, End %>"></asp:Literal><asp:TextBox ID="txtProductCode2" runat="server"></asp:TextBox><asp:Button ID="btnChooseProduct2" runat="server" Text="<%$ Resources:WebResources, Choose %>" />
                        <uc1:PopupWindow ID="PopupWindow2" runat="server"
                                    Name="SelectPromoCode" 
                                    PopupButtonID="btnChooseProduct2" 
                                    TargetControlID="txtProductCode2"
                                    Width="550" Height="400"                       
                                    NavigateUrl="~/VSS/SAL/SAL01_searchProductNo.aspx" />
                    </td>                   
                    <td class="tdtxt" nowrap="nowrap">
                ...
                <div class="SubEditCommand">
                    ...
                    <cc1:ExGridView ID="gvMaster" runat="server" AutoGenerateColumns="False" CssClass="mGrid"
                        ...
                        <Columns>
                           ...
                           <asp:TemplateField HeaderText="<%$ Resources:WebResources, ProductCode %>" ItemStyle-Wrap="false" FooterStyle-Wrap="false">
                                <EditItemTemplate>
                                    <asp:TextBox ID="txtProductCode" runat="server" Text='<%# Bind("商品料號") %>' Width="80"></asp:TextBox><asp:Button ID="ChooseButton1" runat="server" Text="<%$ Resources:WebResources, Choose %>" />
                                ...
                                <ItemTemplate >
                                    <asp:Label ID="lblProductCode" runat="server" Text='<%# Bind("商品料號") %>'></asp:Label>
                                </ItemTemplate>
                                <FooterTemplate>
                                    <asp:TextBox ID="txtProductCode" runat="server" Width="80"></asp:TextBox><asp:Button ID="ChooseButton1" runat="server" Text="<%$ Resources:WebResources, Choose %>" />
                                    <uc1:PopupWindow ID="PopupWindow3" runat="server"
                                    Name="DeliveryOrderNoSearch" 
                                    PopupButtonID="ChooseButton1" 
                                    TargetControlID="txtProductCode"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="<%$ Resources:WebResources, StoreNo %>">
                                            <EditItemTemplate>
                                                ...
                                                <asp:Button ID="Button12" runat="server" Text="<%$ Resources:WebResources, Choose %>" OnClientClick="openwindow('../OPT/OPT13_choseStore.aspx',500,400);" />
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="<%$ Resources:WebResources, StoreName %>" ControlStyle-Width="80">
                                            <EditItemTemplate>
                                                ...
                                                <asp:Label ID="lbl12_1" runat="server" Text='<%# Eval("門市名稱") %>'></asp:Label>
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                            ...
                                            <FooterTemplate>
                                                ...
                                                <asp:Label ID="lbl12_2" runat="server" Text='<%# Eval("門市名稱") %>'></asp:Label>
                                            </FooterTemplate>
                                        </asp:TemplateField> 
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="<%$ Resources:WebResources, ProductName %>">
                                            <EditItemTemplate>
                                                ...
                                                <asp:Label ID="lbl1_1" runat="server" Text='<%# Eval("商品名稱") %>'></asp:Label>
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                            ...
                                            <FooterTemplate>
                                                ...
                                                <asp:Label ID="lbl1_2" runat="server" Text='<%# Eval("商品名稱") %>'></asp:Label>
                                            </FooterTemplate>
                                        </asp:TemplateField> 
